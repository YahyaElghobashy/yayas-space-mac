...
Thanks for helping keep Yaya's Space and the people who use it safe.
...
- **[Report a vulnerability privately](https://github.com/YahyaElghobashy/yayas-space-mac/security/advisories/new)**
...
- The Yaya's Space version from Settings under About and your macOS version.
...
Yaya's Space runs locally and ships as a signed and notarized macOS app. The reports that matter most are the ones that could affect the integrity of the app or its self update flow, or that could let the app's permissions be misused. Issues in the outside services the app merely talks to, like GitHub's releases API or the speed test endpoint, are best taken to those providers.
