...
The GPL license does not grant permission to use the Yaya's Space name, logo, icon,
bundle identity, trade dress, official branding, or any signing identity
controlled by the project maintainer.

Official Yaya's Space builds are distributed only by the project maintainer.
...
Do not present a modified build as Yaya's Space or as an official release unless
