...
// Vorssaint server and handed back a temporary URL. This build never uploads
...
// does the sending. No socket is opened by Vorssaint.
...
enum LocalShareSheet {
    ...
    static func stagingDirectory() -> URL? {
        ...
        let folder = manager.temporaryDirectory
            .appendingPathComponent("Vorssaint Shared Captures", isDirectory: true)
