...
private final class FanControlOwnership {
    private let lockPath = "/var/run/yayasspace-fan-control.lock"
    private let markerPath = "/var/run/yayasspace-fan-control.active"
...
private final class FanControlController {
    private let queue = DispatchQueue(label: "com.yahyaelghobashy.yayasspace.fan-control.helper")
