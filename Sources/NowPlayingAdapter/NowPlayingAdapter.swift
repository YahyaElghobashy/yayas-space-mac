...
// with DynaLoader and calls `yayasspace_now_playing_get`. The app runs that
...
@_cdecl("yayasspace_now_playing_get")
public func yayasspaceNowPlayingGet() {
    ...
    let queue = DispatchQueue(label: "com.yahyaelghobashy.yayasspace.now-playing-adapter")
