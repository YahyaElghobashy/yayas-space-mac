...
final class FanControlService: ObservableObject {
    ...
    private let probeQueue = DispatchQueue(label: "com.yahyaelghobashy.yayasspace.fan-control.probe",
                                           qos: .utility)
    ...
    private static var helperVersion: String {
        Bundle.main.object(forInfoDictionaryKey: "YayasSpaceFanControlHelperVersion") as? String
