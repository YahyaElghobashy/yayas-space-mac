...
final class WindowUseTracker {
    ...
    @objc private func appActivated(_ note: Notification) {
        ...
        // self-activating on the way out; ranking it would put Yaya's Space ahead
        // of the app the user left. Every other activation of Yaya's Space, the
    ...
    private func startWatcher() {
        let thread = lifecycleLock.withLock { () -> Thread? in
            ...
            thread.name = "Yaya's Space Window Focus"
