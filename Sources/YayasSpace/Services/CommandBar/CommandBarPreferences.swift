...
enum CommandBarSource: String, CaseIterable, Identifiable {
    /// What Yaya's Space itself can do. Always on: it is what the bar is for.
    case actions
    case apps
    case menus
    case windows
    case quitApps
    case settingsPages
    /// The Mac's own Settings panes, which are not Yaya's Space's and can be
...
enum CommandBarPreferences {
    ...
    ///
    /// What this Mac holds (the apps, Yaya's Space's own actions, the Settings
