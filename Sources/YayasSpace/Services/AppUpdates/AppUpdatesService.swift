...
final class AppUpdatesService: ObservableObject {
    ...
    private let workQueue = DispatchQueue(label: "com.yahyaelghobashy.yayasspace.appupdates", qos: .utility)
    ...
    private static func isOwnBundle(_ bundleID: String) -> Bool {
        bundleID == Bundle.main.bundleIdentifier || bundleID.hasPrefix("com.yahyaelghobashy.yayasspace")
    }

    private static let ownPackageTokens: Set<String> = ["yayasspace", "yayasspace@beta", "yayasspace-beta"]
