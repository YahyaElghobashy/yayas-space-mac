...
final class RecorderExporter {
    ...
    private static func pump(input: AVAssetWriterInput,
        ...
        let queue = DispatchQueue(label: "com.yahyaelghobashy.yayasspace." + label, qos: .userInitiated)
    ...
    private static func shareDirectory() -> URL? {
        ...
        let directory = cache
            .appendingPathComponent(Bundle.main.bundleIdentifier ?? "com.yahyaelghobashy.yayasspace",
                                    isDirectory: true)
