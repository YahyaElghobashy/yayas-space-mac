...
final class RecorderSystemAudioTap: @unchecked Sendable {
    ...
    private static let teardownQueue = DispatchQueue(label: "com.yahyaelghobashy.yayasspace.recorder.systemaudio.teardown",
                                                     qos: .utility)
    ...
    static func make() async -> RecorderSystemAudioTap? {
        ...
        let queue = DispatchQueue(label: "com.yahyaelghobashy.yayasspace.recorder.systemaudio",
                                  qos: .userInitiated)
    ...
    private init?(queue: DispatchQueue) {
        ...
        description.name = "Yaya's Space Recorder"
    ...
    private func buildPipeline() {
        ...
        let aggregate: [String: Any] = [
            kAudioAggregateDeviceNameKey: "Yaya's Space Recorder",
