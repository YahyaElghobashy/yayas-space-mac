...
final class ScreenshotSelectionController {
    ...
    private var hideYayasSpaceWindows: Bool
    ...
    init(freeze: Bool,
         includePointer: Bool,
         showLastRegion: Bool,
         hideYayasSpaceWindows: Bool = true,
        ...
        self.hideYayasSpaceWindows = hideYayasSpaceWindows
        ...
        self.capturePolicy = ScreenshotSupport.UnifiedCapturePolicy(
            ...
            hideYayasSpaceWindows: hideYayasSpaceWindows,
        ...
        if freeze {
            Task { @MainActor [weak self] in
                ...
                let images = await ScreenshotCaptureEngine.captureAllDisplays(
                    ...
                    hideYayasSpaceWindows: self.hideYayasSpaceWindows,
    ...
    private func screenCaptureToolDidChange() {
        if let activeTool {
            ...
            let nextPolicy = ScreenshotSupport.unifiedCapturePolicy(
                ...
                screenshotHideYayasSpaceWindows: defaults.bool(
                    forKey: DefaultsKey.screenshotHideYayasSpaceWindows))
    ...
    private func adoptCapturePolicy(_ policy: ScreenshotSupport.UnifiedCapturePolicy) {
        ...
        hideYayasSpaceWindows = policy.hideYayasSpaceWindows
        sourceGeneration += 1
    ...
    private func loadLiveLoupeImages() {
        let hideWindows = hideYayasSpaceWindows
        let excludedIDs = captureExcludedWindowIDs
        Task { @MainActor [weak self] in
            let images = await ScreenshotCaptureEngine.captureAllDisplays(
                includePointer: false,
                hideYayasSpaceWindows: hideWindows,
