...
/// active, Esc closes. The panel never activates Yaya's Space, so the target
...
final class SnippetLibraryService: ObservableObject {
    ...
    func insert(_ snippet: TextSnippet) {
        ...
        // app. When Yaya's Space itself is frontmost (its Settings window, for
