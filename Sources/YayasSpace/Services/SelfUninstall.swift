...
enum SelfUninstall {
    private static var bundleID: String { Bundle.main.bundleIdentifier ?? "com.yahyaelghobashy.yayasspace" }
    ...
    /// bundle to the Trash and quits. Used by "Uninstall Yaya's Space completely".
    ...
    private static func trashOwnBundleAndQuit() {
        ...
        let scriptURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("yayasspace-uninstall-\(pid)-\(UUID().uuidString).sh")
        do {
