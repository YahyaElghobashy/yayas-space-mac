...
/// activation this app holds, and Yaya's Space (`LSUIElement`, non-activating
...
enum ActivationHandoff {
    ...
    /// Past that, an activation of Yaya's Space is the user opening one of its
    ...
    /// Whether the activation of Yaya's Space being reported right now is the one
