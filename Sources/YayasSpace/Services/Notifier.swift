...
enum Notifier {
    static let whatsAppOrganizerUndoActionIdentifier =
        "com.yahyaelghobashy.yayasspace.notification.whatsapp-organizer.undo"
    private static let whatsAppOrganizerTransactionKey =
        "com.yahyaelghobashy.yayasspace.notification.whatsapp-organizer.transaction"
    private static let whatsAppOrganizerCategoryIdentifier =
        "com.yahyaelghobashy.yayasspace.notification.whatsapp-organizer"
    private static let log = Logger(subsystem: Bundle.main.bundleIdentifier ?? "yayasspace",
