...
final class ShelfService: ObservableObject {
    ...
    private let tempDir: URL = {
        let id = Bundle.main.bundleIdentifier ?? "com.yahyaelghobashy.yayasspace"
        let dir = FileManager.default.temporaryDirectory
            .appendingPathComponent("YayasSpaceShelf", isDirectory: true)
    ...
    private static let persistQueue = DispatchQueue(label: "com.yahyaelghobashy.yayasspace.shelf-persist",
                                                    qos: .utility)
