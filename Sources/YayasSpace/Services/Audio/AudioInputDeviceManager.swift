...
/// Keeps Yaya's Space's preferred microphone in sync with macOS' global input.
...
final class AudioInputDeviceManager: ObservableObject {
    ...
    private let halQueue = DispatchQueue(label: "com.yahyaelghobashy.yayasspace.audioinput.hal", qos: .userInitiated)
