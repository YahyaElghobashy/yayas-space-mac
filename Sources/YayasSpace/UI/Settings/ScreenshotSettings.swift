...
struct ScreenshotCaptureSettings: View {
    ...
    @AppStorage(DefaultsKey.screenshotHideYayasSpaceWindows) private var hideYayasSpaceWindows = true
        ...
        Group {
            ...
            Section {
                ...
                Text(strings.freezeCaption)
                    .font(.caption)
                    .foregroundStyle(.secondary)
                Toggle(strings.hideYayasSpaceWindowsToggle, isOn: $hideYayasSpaceWindows)
