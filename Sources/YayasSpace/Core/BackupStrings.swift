...
extension BackupFeatureStrings {
    static let ko = BackupFeatureStrings(
        ...
        invalidFile: "이 파일은 유효한 Yaya's Space 백업이 아닙니다."
    )
}
...
extension BackupFeatureStrings {
    static let enUS = BackupFeatureStrings(
        ...
        invalidFile: "This file is not a valid Yaya's Space backup."
    )
    ...
    static let ptBR = BackupFeatureStrings(
        ...
        invalidFile: "Este arquivo não é um backup válido do Yaya's Space."
    )
    ...
    static let tr = BackupFeatureStrings(
        ...
        invalidFile: "Bu dosya geçerli bir Yaya's Space yedeği değil."
    )
    ...
    static let ru = BackupFeatureStrings(
        ...
        invalidFile: "Этот файл не является корректной резервной копией Yaya's Space."
    )
    ...
    static let es = BackupFeatureStrings(
        ...
        invalidFile: "Este archivo no es una copia de seguridad válida de Yaya's Space."
    )
    ...
    static let de = BackupFeatureStrings(
        ...
        invalidFile: "Diese Datei ist kein gültiges Yaya's Space-Backup."
    )
    ...
    static let fr = BackupFeatureStrings(
        ...
        invalidFile: "Ce fichier n’est pas une sauvegarde Yaya's Space valide."
    )
    ...
    static let it = BackupFeatureStrings(
        ...
        invalidFile: "Questo file non è un backup Yaya's Space valido."
    )
    ...
    static let ja = BackupFeatureStrings(
        ...
        invalidFile: "このファイルは有効なYaya's Spaceのバックアップではありません。"
    )
    ...
    static let zhHans = BackupFeatureStrings(
        ...
        importAction: "导入并重启",
        invalidFile: "该文件不是有效的 Yaya's Space 备份。"
    )
    ...
    static let zhTW = BackupFeatureStrings(
        ...
        invalidFile: "此檔案不是有效的 Yaya's Space 備份。"
    )
    ...
    static let zhHK = BackupFeatureStrings(
        ...
        importConfirmBody: "目前設定將被檔案中的設定取代,App 會重新啟動。這台 Mac 上的其他內容不受影響。",
        importAction: "匯入並重新啟動",
        invalidFile: "此檔案不是有效嘅 Yaya's Space 備份。"
    )
}
