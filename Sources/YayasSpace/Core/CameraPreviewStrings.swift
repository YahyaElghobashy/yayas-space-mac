...
extension CameraPreviewFeatureStrings {
    static let enUS = CameraPreviewFeatureStrings(
        ...
        deniedMessage: "Camera access for Yaya's Space is turned off in System Settings.",
    ...
    static let ptBR = CameraPreviewFeatureStrings(
        ...
        deniedMessage: "O acesso à câmera para o Yaya's Space está desativado nos Ajustes do Sistema.",
    ...
    static let tr = CameraPreviewFeatureStrings(
        ...
        deniedMessage: "Yaya's Space için kamera erişimi Sistem Ayarları’nda kapalı.",
    ...
    static let ru = CameraPreviewFeatureStrings(
        ...
        deniedMessage: "Доступ к камере для Yaya's Space отключен в Системных настройках.",
    ...
    static let es = CameraPreviewFeatureStrings(
        ...
        deniedMessage: "El acceso a la cámara para Yaya's Space está desactivado en Ajustes del Sistema.",
    ...
    static let de = CameraPreviewFeatureStrings(
        ...
        cameraMenuLabel: "Kamera",
        deniedMessage: "Der Kamerazugriff für Yaya's Space ist in den Systemeinstellungen deaktiviert.",
    ...
    static let fr = CameraPreviewFeatureStrings(
        ...
        deniedMessage: "L’accès à la caméra pour Yaya's Space est désactivé dans Réglages Système.",
    ...
    static let it = CameraPreviewFeatureStrings(
        ...
        deniedMessage: "L’accesso alla fotocamera per Yaya's Space è disattivato in Impostazioni di Sistema.",
    ...
    static let ja = CameraPreviewFeatureStrings(
        ...
        openButton: "プレビューを開く",
        cameraMenuLabel: "カメラ",
        deniedMessage: "システム設定でYaya's Spaceのカメラへのアクセスがオフになっています。",
    ...
    static let ko = CameraPreviewFeatureStrings(
        ...
        openButton: "미리보기 열기",
        cameraMenuLabel: "카메라",
        deniedMessage: "시스템 설정에서 Yaya's Space의 카메라 접근이 꺼져 있습니다.",
    ...
    static let zhHans = CameraPreviewFeatureStrings(
        ...
        openButton: "打开预览",
        cameraMenuLabel: "相机",
        deniedMessage: "Yaya's Space 的相机访问权限已在系统设置中关闭。",
    ...
    static let zhTW = CameraPreviewFeatureStrings(
        ...
        openButton: "打開預覽",
        cameraMenuLabel: "相機",
        deniedMessage: "Yaya's Space 的相機取用權限已在系統設定中關閉。",
