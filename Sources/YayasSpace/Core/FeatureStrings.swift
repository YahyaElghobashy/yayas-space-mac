...
extension WindowLayoutFeatureStrings {
    static let ko = WindowLayoutFeatureStrings(
        ...
        edgeSnapSystemConflict: "macOS가 같은 가장자리를 사용 중입니다. 데스크탑 및 Dock에서 윈도우 타일링을 끄면 Yaya's Space가 사용할 수 있습니다.",
        edgeSnapOpenSystemSettings: "데스크탑 및 Dock 열기",
        edgeSnapWaitingForSystem: "Yaya's Space에서 켜졌습니다. macOS 타일링을 끄면 바로 작동합니다.",
...
extension MonitorAlertFeatureStrings {
    static let ko = MonitorAlertFeatureStrings(
        ...
        notificationsDenied: "시스템 설정에서 Yaya's Space 알림이 꺼져 있어 경고를 표시할 수 없습니다.",
        cpu: "높은 CPU 사용량",
...
struct WindowLayoutFeatureStrings {
    ...
    static let enUS = WindowLayoutFeatureStrings(
        ...
        edgeSnapSystemConflict: "macOS is using the same edges. Turn off window tiling in Desktop & Dock so Yaya's Space can take over.",
        edgeSnapOpenSystemSettings: "Open Desktop & Dock",
        edgeSnapWaitingForSystem: "Enabled in Yaya's Space. It starts working as soon as macOS tiling is off.",
    ...
    static let ptBR = WindowLayoutFeatureStrings(
        ...
        edgeSnapSystemConflict: "O macOS está usando as mesmas bordas. Desligue o encaixe em Mesa e Dock para o Yaya's Space assumir.",
        edgeSnapOpenSystemSettings: "Abrir Mesa e Dock",
        edgeSnapWaitingForSystem: "Ativado no Yaya's Space. Começa a funcionar assim que o encaixe do macOS for desligado.",
    ...
    static let tr = WindowLayoutFeatureStrings(
        ...
        edgeSnapSystemConflict: "macOS aynı kenarları kullanıyor. Yaya's Space’ın devralması için Masaüstü ve Dock’taki pencere döşemeyi kapatın.",
        edgeSnapOpenSystemSettings: "Masaüstü ve Dock’u Aç",
        edgeSnapWaitingForSystem: "Yaya's Space’ta açık. macOS döşemesi kapanınca çalışmaya başlar.",
    ...
    static let ru = WindowLayoutFeatureStrings(
        ...
        edgeSnapSystemConflict: "macOS использует те же края. Отключите размещение окон в разделе «Рабочий стол и Dock», чтобы их использовал Yaya's Space.",
        edgeSnapOpenSystemSettings: "Открыть «Рабочий стол и Dock»",
        edgeSnapWaitingForSystem: "Включено в Yaya's Space. Заработает сразу после отключения размещения окон macOS.",
    ...
    static let es = WindowLayoutFeatureStrings(
        ...
        edgeSnapSystemConflict: "macOS usa los mismos bordes. Desactiva el ajuste de ventanas en Escritorio y Dock para que Yaya's Space tome el control.",
        edgeSnapOpenSystemSettings: "Abrir Escritorio y Dock",
        edgeSnapWaitingForSystem: "Activado en Yaya's Space. Funcionará en cuanto se desactive el ajuste de ventanas de macOS.",
    ...
    static let de = WindowLayoutFeatureStrings(
        ...
        edgeSnapSystemConflict: "macOS verwendet dieselben Ränder. Deaktiviere die Fensteranordnung unter Schreibtisch & Dock, damit Yaya's Space übernimmt.",
        edgeSnapOpenSystemSettings: "Schreibtisch & Dock öffnen",
        edgeSnapWaitingForSystem: "In Yaya's Space aktiviert. Es funktioniert, sobald die Fensteranordnung von macOS aus ist.",
    ...
    static let fr = WindowLayoutFeatureStrings(
        ...
        edgeSnapSystemConflict: "macOS utilise les mêmes bords. Désactivez le placement des fenêtres dans Bureau et Dock pour laisser Yaya's Space prendre le relais.",
        edgeSnapOpenSystemSettings: "Ouvrir Bureau et Dock",
        edgeSnapWaitingForSystem: "Activé dans Yaya's Space. Il fonctionnera dès que le placement des fenêtres de macOS sera désactivé.",
    ...
    static let it = WindowLayoutFeatureStrings(
        ...
        edgeSnapSystemConflict: "macOS usa gli stessi bordi. Disattiva l’affiancamento in Scrivania e Dock per lasciare il controllo a Yaya's Space.",
        edgeSnapOpenSystemSettings: "Apri Scrivania e Dock",
        edgeSnapWaitingForSystem: "Attivato in Yaya's Space. Funzionerà appena l’affiancamento di macOS sarà disattivato.",
    ...
    static let ja = WindowLayoutFeatureStrings(
        ...
        edgeSnapSystemConflict: "macOSが同じ画面端を使用しています。Yaya's Spaceで使うには「デスクトップとDock」でウインドウのタイル表示をオフにしてください。",
        edgeSnapOpenSystemSettings: "デスクトップとDockを開く",
        edgeSnapWaitingForSystem: "Yaya's Spaceでオンになっています。macOSのタイル表示をオフにすると動作します。",
    ...
    static let zhHans = WindowLayoutFeatureStrings(
        ...
        edgeSnapSystemConflict: "macOS 正在使用相同的屏幕边缘。请在“桌面与程序坞”中关闭窗口平铺，让 Yaya's Space 接管。",
        edgeSnapOpenSystemSettings: "打开桌面与程序坞",
        edgeSnapWaitingForSystem: "已在 Yaya's Space 中开启。关闭 macOS 窗口平铺后即可使用。",
    ...
    static let zhTW = WindowLayoutFeatureStrings(
        ...
        edgeSnapSystemConflict: "macOS 正在使用相同的螢幕邊緣。請在「桌面與 Dock」關閉視窗並排，讓 Yaya's Space 接管。",
        edgeSnapOpenSystemSettings: "開啟桌面與 Dock",
        edgeSnapWaitingForSystem: "已在 Yaya's Space 中開啟。關閉 macOS 視窗並排後即可使用。",
...
struct MonitorAlertFeatureStrings {
    ...
    static let enUS = MonitorAlertFeatureStrings(
        ...
        notificationsDenied: "Notifications for Yaya's Space are off in System Settings, so alerts cannot appear.",
        cpu: "High CPU",
    ...
    static let ptBR = MonitorAlertFeatureStrings(
        ...
        notificationsDenied: "As notificações do Yaya's Space estão desativadas nos Ajustes do Sistema, então os alertas não aparecem.",
        cpu: "CPU alta",
    ...
    static let tr = MonitorAlertFeatureStrings(
        ...
        notificationsDenied: "Sistem Ayarları’nda Yaya's Space bildirimleri kapalı, bu yüzden uyarılar görünemez.",
        cpu: "Yüksek CPU",
    ...
    static let ru = MonitorAlertFeatureStrings(
        ...
        notificationsDenied: "Уведомления Yaya's Space выключены в Системных настройках, поэтому оповещения не появятся.",
    ...
    static let es = MonitorAlertFeatureStrings(
        ...
        notificationsDenied: "Las notificaciones de Yaya's Space están desactivadas en Ajustes del Sistema, así que las alertas no aparecen.",
        cpu: "CPU alta",
    ...
    static let de = MonitorAlertFeatureStrings(
        ...
        notificationsDenied: "Mitteilungen für Yaya's Space sind in den Systemeinstellungen aus, daher können keine Warnungen erscheinen.",
        cpu: "Hohe CPU",
    ...
    static let fr = MonitorAlertFeatureStrings(
        ...
        notificationsDenied: "Les notifications de Yaya's Space sont désactivées dans Réglages Système, les alertes ne peuvent donc pas apparaître.",
        cpu: "CPU élevé",
    ...
    static let it = MonitorAlertFeatureStrings(
        ...
        notificationsDenied: "Le notifiche di Yaya's Space sono disattivate in Impostazioni di Sistema, quindi gli avvisi non compaiono.",
        cpu: "CPU alta",
    ...
    static let ja = MonitorAlertFeatureStrings(
        ...
        notificationsDenied: "システム設定でYaya's Spaceの通知がオフのため、アラートは表示されません。",
        cpu: "CPU 高負荷",
    ...
    static let zhHans = MonitorAlertFeatureStrings(
        ...
        notificationsDenied: "Yaya's Space 的通知已在系统设置中关闭，警报无法显示。",
        cpu: "CPU 过高",
    ...
    static let zhTW = MonitorAlertFeatureStrings(
        ...
        notificationsDenied: "Yaya's Space 的通知已在系統設定中關閉，警示無法顯示。",
        cpu: "CPU 使用率過高",
