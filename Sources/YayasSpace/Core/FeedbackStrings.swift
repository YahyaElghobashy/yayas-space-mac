...
extension FeedbackStrings {
    static let enUS = FeedbackStrings(
        ...
        sectionCaption: "Send a bug report or feature idea directly to the person who maintains Yaya's Space.",
    ...
    static let ptBR = FeedbackStrings(
        sectionTitle: "Feedback",
        sectionCaption: "Envie um relato de bug ou uma ideia de recurso diretamente para quem mantém o Yaya's Space.",
    ...
    static let tr = FeedbackStrings(
        ...
        sectionCaption: "Bir hata bildirimini veya özellik fikrini doğrudan Yaya's Space bakımcısına gönderin.",
    ...
    static let ru = FeedbackStrings(
        ...
        sectionCaption: "Отправьте сообщение об ошибке или идею функции напрямую разработчику Yaya's Space.",
    ...
    static let es = FeedbackStrings(
        ...
        sectionCaption: "Envía un informe de error o una idea directamente a quien mantiene Yaya's Space.",
    ...
    static let de = FeedbackStrings(
        sectionTitle: "Feedback",
        sectionCaption: "Sende einen Fehlerbericht oder eine Funktionsidee direkt an den Yaya's Space-Entwickler.",
    ...
    static let fr = FeedbackStrings(
        sectionTitle: "Avis",
        sectionCaption: "Envoyez un rapport de bug ou une idée directement à la personne qui maintient Yaya's Space.",
    ...
    static let it = FeedbackStrings(
        sectionTitle: "Feedback",
        sectionCaption: "Invia una segnalazione o un’idea direttamente a chi mantiene Yaya's Space.",
    ...
    static let ja = FeedbackStrings(
        ...
        sectionCaption: "不具合の報告や機能のアイデアを Yaya's Space の開発者へ直接送信します。",
    ...
    static let ko = FeedbackStrings(
        sectionTitle: "피드백",
        sectionCaption: "버그 신고나 기능 아이디어를 Yaya's Space 관리자에게 직접 보냅니다.",
        openButton: "피드백 보내기",
        windowTitle: "피드백 보내기",
        bugTitle: "버그",
    ...
    static let zhHans = FeedbackStrings(
        sectionTitle: "反馈",
        sectionCaption: "将错误报告或功能建议直接发送给 Yaya's Space 的维护者。",
        openButton: "发送反馈",
        windowTitle: "发送反馈",
        bugTitle: "错误",
        featureTitle: "功能建议",
    ...
    static let zhTW = FeedbackStrings(
        sectionTitle: "意見回饋",
        sectionCaption: "將錯誤回報或功能建議直接傳送給 Yaya's Space 的維護者。",
        openButton: "傳送意見",
        windowTitle: "傳送意見",
        bugTitle: "錯誤",
        featureTitle: "功能建議",
    ...
    static let zhHK = FeedbackStrings(
        sectionTitle: "意見回饋",
        sectionCaption: "將錯誤報告或功能建議直接傳送給 Yaya's Space 的維護者。",
        openButton: "傳送意見",
        windowTitle: "傳送意見",
        bugTitle: "錯誤",
        featureTitle: "功能建議",
