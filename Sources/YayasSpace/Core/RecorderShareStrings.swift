...
extension RecorderShareStrings {
    static let enUS = RecorderShareStrings(
        ...
        privacyData: "Yaya's Space sends only the final video created from this recording, including the audio you kept, and the expiration you choose. It does not send your name, account or device identifier.",
    ...
    static let ptBR = RecorderShareStrings(
        ...
        privacyData: "O Yaya's Space envia somente o vídeo final criado desta gravação, incluindo o áudio que você manteve, e o prazo escolhido. Não envia seu nome, conta nem identificador do aparelho.",
    ...
    static let tr = RecorderShareStrings(
        ...
        privacyData: "Yaya's Space yalnızca bu kayıttan oluşturulan son videoyu, koruduğunuz sesle ve seçtiğiniz süreyle birlikte gönderir. Adınızı, hesabınızı veya aygıt kimliğinizi göndermez.",
    ...
    static let ru = RecorderShareStrings(
        ...
        privacyData: "Yaya's Space отправляет только готовое видео из этой записи, включая оставленный вами звук, и выбранный срок. Имя, учётная запись и идентификатор устройства не отправляются.",
    ...
    static let es = RecorderShareStrings(
        ...
        privacyData: "Yaya's Space envía solo el vídeo final creado a partir de esta grabación, incluido el audio que conservaste, y el plazo elegido. No envía tu nombre, cuenta ni identificador del dispositivo.",
    ...
    static let de = RecorderShareStrings(
        ...
        privacyData: "Yaya's Space sendet nur das fertige Video aus dieser Aufnahme, einschließlich des beibehaltenen Tons, und die gewählte Dauer. Name, Konto und Gerätekennung werden nicht gesendet.",
    ...
    static let fr = RecorderShareStrings(
        ...
        privacyData: "Yaya's Space envoie uniquement la vidéo finale créée à partir de cet enregistrement, avec l’audio conservé, et la durée choisie. Votre nom, compte et identifiant d’appareil ne sont pas envoyés.",
    ...
    static let it = RecorderShareStrings(
        ...
        privacyData: "Yaya's Space invia solo il video finale creato da questa registrazione, incluso l’audio mantenuto, e la durata scelta. Non invia nome, account o identificativo del dispositivo.",
    ...
    static let ja = RecorderShareStrings(
        ...
        privacyData: "Yaya's Spaceが送信するのは、この録画から作成した完成動画、残した音声、選んだ有効期限だけです。名前、アカウント、デバイス識別子は送信しません。",
    ...
    static let ko = RecorderShareStrings(
        ...
        privacyData: "Yaya's Space는 이 녹화에서 만든 최종 동영상과 유지한 오디오, 선택한 만료 시간만 전송합니다. 이름, 계정 또는 기기 식별자는 전송하지 않습니다.",
    ...
    static let zhHans = RecorderShareStrings(
        ...
        privacyData: "Yaya's Space只会发送由这段录制生成的最终视频、你保留的音频和所选有效期，不会发送姓名、账户或设备标识符。",
    ...
    static let zhTW = RecorderShareStrings(
        ...
        privacyData: "Yaya's Space只會傳送由這段錄製建立的最終影片、你保留的音訊和所選期限，不會傳送姓名、帳號或裝置識別碼。",
    ...
    static let zhHK = RecorderShareStrings(
        ...
        privacyData: "Yaya's Space只會傳送由這段錄製建立的最終影片、你保留的音訊和所選期限，不會傳送姓名、帳戶或裝置識別碼。",
