...
enum DefaultsKey {
    ...
    static let sleepDisabledFlag = "yayasspaceDisabledSleep"   // internal guard for pmset disablesleep
    ...
    // Set only while Yaya's Space owes a Bluetooth restore, so a Mac shut down
    ...
    static let screenshotHideYayasSpaceWindows = "screenshotHideYayasSpaceWindows"
...
enum SupportUpdateIntroStep: CaseIterable, Hashable {
    // Yaya's Space: the upstream "follow on X" page is gone; one page remains.
    case support

    var next: SupportUpdateIntroStep? { nil }
    var previous: SupportUpdateIntroStep? { nil }
}
...
enum KeepAwakeActiveIcon: String, CaseIterable, Identifiable {
    case yayasspace, coffee, eye, moon, light
    ...
    var menuBarDrop: CGFloat {
        ...
        case .yayasspace, .eye, .moon: return 0
        }
    }

    func title(_ strings: Strings) -> String {
        switch self {
        case .yayasspace: return strings.keepAwakeActiveIconYayasSpace
...
enum Defaults {
    ...
    static let registeredDefaults: [String: Any] = [
        ...
        DefaultsKey.keepAwakeActiveIcon: KeepAwakeActiveIcon.yayasspace.rawValue,
        ...
        DefaultsKey.screenshotHideYayasSpaceWindows: true,
