...
extension WhatsAppOrganizerStrings {
    static let enUS = WhatsAppOrganizerStrings(
        ...
        enabledCaption: "WhatsApp may download a moved file again. Yaya's Space cannot prevent the network download, but it can detect and discard an identical extra copy.",
    ...
    static let es = WhatsAppOrganizerStrings(
        ...
        enabledCaption: "WhatsApp puede volver a descargar un archivo movido. Yaya's Space no puede impedir esa descarga, pero sí detectar y descartar una nueva copia idéntica.",
    ...
    static let ptBR = WhatsAppOrganizerStrings(
        ...
        enabledCaption: "O WhatsApp pode baixar novamente um arquivo movido. O Yaya's Space não impede o download, mas detecta e descarta uma nova cópia idêntica.",
    ...
    static let de = WhatsAppOrganizerStrings(
        ...
        enabledCaption: "WhatsApp kann eine verschobene Datei erneut herunterladen. Yaya's Space kann den Netzwerk-Download nicht verhindern, aber eine identische zusätzliche Kopie erkennen und aussortieren.",
    ...
    static let fr = WhatsAppOrganizerStrings(
        ...
        enabledCaption: "WhatsApp peut retélécharger un fichier déplacé. Yaya's Space ne peut pas empêcher le téléchargement réseau, mais peut détecter et écarter une copie supplémentaire identique.",
    ...
    static let it = WhatsAppOrganizerStrings(
        ...
        enabledCaption: "WhatsApp può scaricare di nuovo un file spostato. Yaya's Space non può impedire il download di rete, ma può rilevare e scartare una copia aggiuntiva identica.",
    ...
    static let tr = WhatsAppOrganizerStrings(
        ...
        enabledCaption: "WhatsApp taşınan bir dosyayı yeniden indirebilir. Yaya's Space ağ indirmesini engelleyemez, ancak birebir aynı fazladan kopyayı saptayıp ayıklayabilir.",
    ...
    static let ru = WhatsAppOrganizerStrings(
        ...
        enabledCaption: "WhatsApp может снова загрузить перемещённый файл. Yaya's Space не может помешать сетевой загрузке, но распознаёт идентичную лишнюю копию и отсеивает её.",
    ...
    static let zhHans = WhatsAppOrganizerStrings(
        ...
        enabled: "自动整理",
        enabledCaption: "WhatsApp 可能会再次下载已移动的文件。Yaya's Space 无法阻止网络下载，但能识别并剔除完全相同的多余副本。",
        destination: "目标文件夹",
        chooseFolder: "选择…",
    ...
    static let zhTW = WhatsAppOrganizerStrings(
        ...
        enabled: "自動整理",
        enabledCaption: "WhatsApp 可能會再次下載已移動的檔案。Yaya's Space 無法阻止網路下載，但能辨識並剔除完全相同的多餘副本。",
        destination: "目標資料夾",
        chooseFolder: "選擇…",
