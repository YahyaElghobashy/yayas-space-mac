...
extension WhatsAppDownloadStrings {
    static let enUS = WhatsAppDownloadStrings(
        ...
        accessDenied: "Yaya's Space cannot access Downloads. Allow it in Files & Folders.",
        ...
        localNote: "Only local file metadata is inspected. Yaya's Space never reads chats or file contents.",
    ...
    static let es = WhatsAppDownloadStrings(
        ...
        accessDenied: "Yaya's Space no puede acceder a Descargas. Permite el acceso en Archivos y carpetas.",
        ...
        localNote: "Solo se consultan metadatos locales. Yaya's Space nunca lee los chats ni el contenido de los archivos.",
    ...
    static let ptBR = WhatsAppDownloadStrings(
        ...
        accessDenied: "O Yaya's Space não pode acessar Downloads. Permita em Arquivos e Pastas.",
        ...
        localNote: "Apenas metadados locais são consultados. O Yaya's Space nunca lê conversas nem o conteúdo dos arquivos.",
    ...
    static let de = translated(language: .de,
        ...
        accessDenied: "Yaya's Space kann nicht auf Downloads zugreifen. Erlaube den Zugriff unter Dateien & Ordner.",
    ...
    static let fr = translated(language: .fr,
        ...
        accessDenied: "Yaya's Space ne peut pas accéder à Téléchargements. Autorisez-le dans Fichiers et dossiers.",
    ...
    static let it = translated(language: .it,
        ...
        accessDenied: "Yaya's Space non può accedere a Download. Consenti l’accesso in File e cartelle.",
    ...
    static let tr = translated(language: .tr,
        ...
        accessDenied: "Yaya's Space İndirilenler’e erişemiyor. Dosyalar ve Klasörler’den izin verin.",
    ...
    static let ru = translated(language: .ru,
        ...
        accessDenied: "Yaya's Space не может открыть Загрузки. Разрешите доступ в разделе «Файлы и папки».",
    ...
    static let zhHans = translated(language: .zhHans,
        ...
        accessDenied: "Yaya's Space 无法访问下载文件夹。请在“文件与文件夹”中允许访问。",
    ...
    static let zhTW = translated(language: .zhTW,
        ...
        accessDenied: "Yaya's Space 無法取用下載項目。請在「檔案與資料夾」允許取用。",
    ...
    private static func operational(_ language: AppLanguage) -> OperationalStrings {
        ...
        case .de:
            return OperationalStrings(
                ...
                localNote: "Nur lokale Metadaten werden geprüft. Yaya's Space liest weder Chats noch Dateiinhalte.",
        ...
        case .fr:
            return OperationalStrings(
                ...
                localNote: "Seules les métadonnées locales sont consultées. Yaya's Space ne lit ni les discussions ni le contenu des fichiers.",
        ...
        case .it:
            return OperationalStrings(
                ...
                localNote: "Vengono controllati solo metadati locali. Yaya's Space non legge chat o contenuti dei file.",
        ...
        case .tr:
            return OperationalStrings(
                ...
                localNote: "Yalnızca yerel meta veriler incelenir. Yaya's Space sohbetleri veya dosya içeriklerini okumaz.",
        ...
        case .ru:
            return OperationalStrings(
                ...
                localNote: "Проверяются только локальные метаданные. Yaya's Space не читает чаты и содержимое файлов.",
        ...
        case .zhHans:
            return OperationalStrings(
                ...
                localNote: "只检查本地元数据。Yaya's Space 绝不读取聊天或文件内容。",
        ...
        case .zhTW, .zhHK:
            return OperationalStrings(
                ...
                localNote: "只檢查本機中繼資料。Yaya's Space 絕不讀取對話或檔案內容。",
