...
extension BluetoothSleepStrings {
    static let enUS = BluetoothSleepStrings(
        ...
        restoreCaption: "Only when Yaya's Space was the one that switched it off.",
    ...
    static let ptBR = BluetoothSleepStrings(
        ...
        restoreCaption: "Apenas quando foi o Yaya's Space que o desligou.",
    ...
    static let tr = BluetoothSleepStrings(
        ...
        restoreCaption: "Yalnızca kapatan Yaya's Space olduğunda.",
    ...
    static let ru = BluetoothSleepStrings(
        ...
        restoreCaption: "Только если его выключил сам Yaya's Space.",
    ...
    static let es = BluetoothSleepStrings(
        ...
        restoreCaption: "Solo cuando fue Yaya's Space quien lo apagó.",
    ...
    static let de = BluetoothSleepStrings(
        ...
        restoreCaption: "Nur wenn Yaya's Space es ausgeschaltet hat.",
    ...
    static let fr = BluetoothSleepStrings(
        ...
        restoreCaption: "Uniquement si c’est Yaya's Space qui l’a coupé.",
    ...
    static let it = BluetoothSleepStrings(
        ...
        restoreCaption: "Solo quando è stato Yaya's Space a spegnerlo.",
    ...
    static let ja = BluetoothSleepStrings(
        ...
        restoreCaption: "Yaya's Spaceが切った場合のみ戻します。",
    ...
    static let ko = BluetoothSleepStrings(
        ...
        restoreCaption: "Yaya's Space가 껐을 때만 다시 켭니다.",
    ...
    static let zhHans = BluetoothSleepStrings(
        ...
        restoreCaption: "仅在蓝牙是由 Yaya's Space 关闭时。",
    ...
    static let zhTW = BluetoothSleepStrings(
        ...
        restoreCaption: "僅在藍牙是由 Yaya's Space 關閉時。",
    ...
    static let zhHK = BluetoothSleepStrings(
        ...
        restoreToggle: "Mac 喚醒時重新開啟藍牙",
        restoreCaption: "只在藍牙是由 Yaya's Space 關閉時。",
