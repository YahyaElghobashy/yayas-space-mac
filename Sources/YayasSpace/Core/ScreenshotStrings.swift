...
struct ScreenshotFeatureStrings {
    ...
    let hideYayasSpaceWindowsToggle: String
...
extension ScreenshotFeatureStrings {
    static let enUS = ScreenshotFeatureStrings(
        ...
        sharePrivacyData: "Yaya's Space sends only the rendered image and the expiration you choose. It does not send your name, account, device identifier or MAC address. On this Mac, it keeps only the link, expiration and private deletion token while the link is active.",
        ...
        hideYayasSpaceWindowsToggle: "Hide Yaya's Space windows",
    ...
    static let ptBR = ScreenshotFeatureStrings(
        ...
        sharePrivacyData: "O Yaya's Space envia somente a imagem renderizada e o prazo que você escolher. Ele não envia seu nome, conta, identificador do aparelho nem endereço MAC. Neste Mac, guarda apenas o link, o prazo e o token privado de exclusão enquanto o link estiver ativo.",
        ...
        hideYayasSpaceWindowsToggle: "Ocultar janelas do Yaya's Space",
    ...
    static let tr = ScreenshotFeatureStrings(
        ...
        sharePrivacyData: "Yaya's Space yalnızca işlenmiş görüntüyü ve seçtiğiniz süreyi gönderir. Adınızı, hesabınızı, aygıt tanımlayıcınızı veya MAC adresinizi göndermez. Bu Mac’te bağlantı etkinken yalnızca bağlantı, sona erme zamanı ve özel silme anahtarı saklanır.",
        ...
        hideYayasSpaceWindowsToggle: "Yaya's Space pencerelerini gizle",
    ...
    static let ru = ScreenshotFeatureStrings(
        ...
        sharePrivacyData: "Yaya's Space отправляет только готовое изображение и выбранный срок действия. Он не отправляет ваше имя, учётную запись, идентификатор устройства или MAC-адрес. На этом Mac сохраняются только ссылка, срок действия и закрытый токен удаления, пока ссылка активна.",
        ...
        hideYayasSpaceWindowsToggle: "Скрывать окна Yaya's Space",
    ...
    static let es = ScreenshotFeatureStrings(
        ...
        sharePrivacyData: "Yaya's Space solo envía la imagen procesada y el plazo que elijas. No envía tu nombre, cuenta, identificador del dispositivo ni dirección MAC. En este Mac solo guarda el enlace, el vencimiento y el token privado de eliminación mientras el enlace está activo.",
        ...
        hideYayasSpaceWindowsToggle: "Ocultar ventanas de Yaya's Space",
    ...
    static let de = ScreenshotFeatureStrings(
        ...
        sharePrivacyData: "Yaya's Space sendet nur das fertige Bild und die gewählte Ablaufzeit. Name, Konto, Gerätekennung und MAC-Adresse werden nicht gesendet. Auf diesem Mac bleiben nur der Link, die Ablaufzeit und das private Löschtoken gespeichert, solange der Link aktiv ist.",
        ...
        hideYayasSpaceWindowsToggle: "Yaya's Space-Fenster ausblenden",
    ...
    static let fr = ScreenshotFeatureStrings(
        ...
        sharePrivacyData: "Yaya's Space envoie uniquement l’image finale et la durée choisie. Il n’envoie ni votre nom, ni votre compte, ni l’identifiant de l’appareil, ni l’adresse MAC. Sur ce Mac, seuls le lien, son expiration et le jeton privé de suppression sont conservés tant que le lien est actif.",
        ...
        hideYayasSpaceWindowsToggle: "Masquer les fenêtres Yaya's Space",
    ...
    static let it = ScreenshotFeatureStrings(
        ...
        sharePrivacyData: "Yaya's Space invia solo l’immagine elaborata e la scadenza scelta. Non invia nome, account, identificatore del dispositivo o indirizzo MAC. Su questo Mac conserva solo il link, la scadenza e il token privato di eliminazione mentre il link è attivo.",
        ...
        hideYayasSpaceWindowsToggle: "Nascondi le finestre di Yaya's Space",
    ...
    static let ja = ScreenshotFeatureStrings(
        ...
        sharePrivacyData: "Yaya's Space が送信するのは、書き出した画像と選択した有効期限だけです。氏名、アカウント、デバイス識別子、MACアドレスは送信しません。このMacには、リンクが有効な間だけリンク、有効期限、非公開の削除トークンが保存されます。",
        ...
        hideYayasSpaceWindowsToggle: "Yaya's Spaceのウインドウを隠す",
    ...
    static let ko = ScreenshotFeatureStrings(
        ...
        sharePrivacyData: "Yaya's Space은 완성된 이미지와 선택한 만료 시간만 전송합니다. 이름, 계정, 기기 식별자 또는 MAC 주소는 전송하지 않습니다. 이 Mac에는 링크가 활성화된 동안 링크, 만료 시간 및 비공개 삭제 토큰만 보관됩니다.",
        ...
        hideYayasSpaceWindowsToggle: "Yaya's Space 윈도우 가리기",
    ...
    static let zhHans = ScreenshotFeatureStrings(
        ...
        sharePrivacyData: "Yaya's Space 只会发送处理后的图片和你选择的有效期，不会发送姓名、账户、设备标识符或 MAC 地址。链接有效期间，这台 Mac 只保存链接、到期时间和私密删除令牌。",
        ...
        hideYayasSpaceWindowsToggle: "隐藏 Yaya's Space 窗口",
    ...
    static let zhTW = ScreenshotFeatureStrings(
        ...
        sharePrivacyData: "Yaya's Space 只會傳送處理後的圖片和你選擇的有效期限，不會傳送姓名、帳號、裝置識別碼或 MAC 位址。連結有效期間，這台 Mac 只會保存連結、到期時間和私人刪除權杖。",
        ...
        previewPositionBottomLeft: "左下角",
        previewPositionBottomRight: "右下角",
        hideYayasSpaceWindowsToggle: "隱藏 Yaya's Space 視窗",
    ...
    static let zhHK = ScreenshotFeatureStrings(
        ...
        sharePrivacyData: "Yaya's Space 只會傳送處理後的圖片同你揀選嘅有效期限，唔會傳送姓名、帳戶、裝置識別碼或 MAC 位址。連結有效期間，呢部 Mac 只會保存連結、到期時間同私人刪除權杖。",
