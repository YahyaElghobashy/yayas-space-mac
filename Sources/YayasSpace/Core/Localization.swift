...
struct Strings {
    ...
    let keepAwakeActiveIconYayasSpace: String
...
extension Strings {
    static let ptBR = Strings(
        statusIdleTooltip: "Yaya's Space: suspensão normal",
        statusActiveUntil: "Yaya's Space: ativo até",
        statusActiveIndefinite: "Yaya's Space: ativo indefinidamente",
        menuEnableAwake: "Ativar manter acordado",
        menuDisableAwake: "Desativar manter acordado",
        menuActivateFor: "Ativar por…",
        menuSettings: "Ajustes…",
        menuAbout: "Sobre o Yaya's Space",
        menuQuit: "Sair do Yaya's Space",
        menuHide: "Ocultar o Yaya's Space",
        ...
        keepAwakeActiveIconYayasSpace: "Yaya's Space",
        ...
        notifyBatteryTitle: "Yaya's Space desativado",
        notifyBatteryBody: "Bateria baixa. A suspensão normal foi restaurada para proteger a carga.",
        adminPromptClamshellOn: "O Yaya's Space precisa da sua senha para manter o Mac ativo com a tampa fechada.",
        adminPromptClamshellOff: "O Yaya's Space precisa da sua senha para reativar a suspensão normal do Mac.",
        adminPromptRecover: "O Yaya's Space foi encerrado com a suspensão do Mac desativada. Digite a senha para restaurar a suspensão normal.",
        adminPromptUpdate: "O Yaya's Space precisa da sua senha para instalar a atualização.",
        adminPromptSudoersInstall: "O Yaya's Space vai criar uma regra restrita (somente pmset disablesleep) para alternar a tampa fechada sem pedir senha. Esta é a única vez que a senha será necessária.",
        adminPromptSudoersRemove: "O Yaya's Space vai remover a regra de tampa fechada sem senha.",

        settingsTitle: "Ajustes do Yaya's Space",
        tabGeneral: "Geral",
        tabEnergy: "Energia",
        ...
        advancedResetDescription: "Remove todas as permissões que você concedeu ao Yaya's Space (Acessibilidade, Gravação de Tela, Acesso Total ao Disco e outras), o item de início e a regra de tampa fechada. Útil para começar do zero ou antes de desinstalar. O app continua instalado.",
        ...
        advancedUninstallDescription: "Faz tudo acima e ainda apaga as preferências e move o Yaya's Space para a Lixeira, sem deixar rastro no sistema. O app fecha ao final. Você pode reinstalar quando quiser.",
        advancedUninstallButton: "Desinstalar o Yaya's Space completamente",
        advancedUninstallConfirmTitle: "Desinstalar o Yaya's Space?",
        advancedUninstallConfirmBody: "O Yaya's Space vai limpar as permissões, apagar as preferências e ir para a Lixeira, e então fechar. Esta ação não pode ser desfeita pelo app, mas ele fica na Lixeira até você esvaziá-la.",
        advancedUninstallFailedTitle: "A desinstalação parou",
        advancedUninstallFailedBody: "O Yaya's Space não conseguiu restaurar uma configuração do sistema que ele mudou: repouso, velocidade das ventoinhas ou aceleração do mouse. Nada foi removido. Tente de novo e permita o pedido de senha, se ele aparecer.",
        ...
        keepAwakeAutoStart: "Manter acordado ao abrir o Yaya's Space",
        ...
        switcherEnable: "Usar o alternador do Yaya's Space",
        ...
        switcherTakeOverSystemShortcutsCaption: "Desativa os atalhos correspondentes de apps e janelas do macOS somente enquanto o alternador do Yaya's Space estiver ativo. Todos os apps abertos continuam acessíveis.",
        ...
        uninstallerFDAHint: "Ative o Yaya's Space na lista. Se ele não aparecer, clique no + e escolha o Yaya's Space em Aplicativos. O acesso só vale depois de reabrir o app.",
        ...
        homebrewMissingBody: "O Yaya's Space pode abrir o Terminal com o instalador oficial do Homebrew. O Terminal mostra os passos e pede sua senha se precisar.",
        ...
        homebrewShellSetupBody: "O Homebrew está instalado, mas o Terminal ainda pode não encontrar o comando brew. O Yaya's Space pode abrir o Terminal com o comando de configuração.",
        ...
        homebrewTerminalFallback: "Esta operação precisa do Terminal para pedir a senha de administrador. O Yaya's Space não captura senhas.",
        ...
        updateNotifyTitle: "Atualização do Yaya's Space",
        ...
        updateNeedsApplicationsTitle: "Mova o Yaya's Space para Aplicativos",
        updateNeedsApplicationsBody: "O app está rodando de um lugar que não dá para atualizar, como a imagem de disco ou uma área temporária do sistema. Arraste o Yaya's Space para a pasta Aplicativos, abra de lá e tente de novo.",
        ...
        obStart: "Abrir o Yaya's Space",
        obStepWelcomeTitle: "Bem-vindo ao Yaya's Space",
        ...
        obStepDoneBody: "O Yaya's Space já está cuidando do seu Mac.",
        ...
        obLanguageUpdateBody: "O Yaya's Space agora fala vários idiomas. Escolha o que você prefere usar; dá para mudar quando quiser nos Ajustes.",
        ...
        cleaningNeedsAxBody: "Para bloquear o teclado com segurança, o Yaya's Space precisa da permissão de Acessibilidade. Conceda em Ajustes do Sistema e tente de novo.",
        ...
        donateHeading: "Ajude o Yaya's Space a continuar crescendo",
        donateMessage: "O Yaya's Space é gratuito, independente e desenvolvido no meu tempo livre. Se você quiser contribuir financeiramente, o Buy Me a Coffee ajuda diretamente a manter o desenvolvimento avançando.",
        donateButton: "Apoiar no Buy Me a Coffee",
        donateThanks: "Obrigado por estar aqui. 🖤",
        supportIntroTitle: "Ajude o Yaya's Space a continuar crescendo",
        ...
        supportIntroStarMessage: "Apoio financeiro nunca é esperado. Dar uma estrela no GitHub ajuda mais pessoas a encontrar o Yaya's Space e faz uma diferença enorme no desenvolvimento.",
        supportIntroCoffeeButton: "Apoiar no Buy Me a Coffee",
        supportIntroLaterButton: "Agora não",
        supportIntroDoneButton: "Concluir",
        discordIntroTitle: "A comunidade do Yaya's Space no Discord está começando",
        discordIntroMessage: "A comunidade do Yaya's Space é nova e ainda está em desenvolvimento. Entre desde o começo para conhecer outros usuários e ajudar a construir um espaço acolhedor em torno do app.",
        ...
        communityIntroFollowButton: "Seguir @YahyaElghobashy no X",
        homebrewOfficialIntroTitle: "Agora no catálogo oficial do Homebrew",
        homebrewOfficialIntroMessage: "O Yaya's Space agora pode ser instalado direto do catálogo oficial do Homebrew.",
        ...
        showMenuBarIconCaption: "Se o ícone do Yaya's Space sumir (o macOS pode esconder ícones quando a barra de menus fica sem espaço, comum em Macs com notch), reabra o Yaya's Space pela pasta Aplicativos ou pelo Spotlight: isso recria o ícone e, se ele ainda estiver escondido, abre esta janela.",
        ...
        menuBarIconManagerHintFormat: "O %@ está aberto e pode estar guardando o ícone na seção oculta dele. Procure o Yaya's Space lá, ou configure o %@ para sempre mostrar o Yaya's Space.",
        ...
        cleanerNotifDenied: "As notificações do Yaya's Space estão desativadas no sistema.",
        cleanerNotifOpenSettings: "Abrir Ajustes de Notificações…",
        launchAtLoginNeedsApplications: "O app está rodando de um lugar que não permite abrir no login. Arraste o Yaya's Space para a pasta Aplicativos, abra de lá e ligue de novo.",
        launchAtLoginNeedsApproval: "O item de login está registrado, mas continua desligado nos Ajustes do Sistema. Abra Ajustes do Sistema › Geral › Itens de Início e Extensões e ligue o Yaya's Space em “Abrir ao iniciar sessão”.",
        ...
        mouseAccelerationCaption: "Remove a aceleração do cursor para os mouses conectados. A configuração anterior volta ao desligar esta opção ou sair do Yaya's Space.",
...
extension Strings {
    static let enUS = Strings(
        statusIdleTooltip: "Yaya's Space: normal sleep",
        statusActiveUntil: "Yaya's Space: awake until",
        statusActiveIndefinite: "Yaya's Space: awake indefinitely",
        menuEnableAwake: "Enable keep awake",
        menuDisableAwake: "Disable keep awake",
        menuActivateFor: "Activate for…",
        menuSettings: "Settings…",
        menuAbout: "About Yaya's Space",
        menuQuit: "Quit Yaya's Space",
        menuHide: "Hide Yaya's Space",
        ...
        notifyBatteryTitle: "Yaya's Space disabled",
        notifyBatteryBody: "Low battery. Normal sleep was restored to protect the charge.",
        adminPromptClamshellOn: "Yaya's Space needs your password to keep the Mac going with the lid closed.",
        adminPromptClamshellOff: "Yaya's Space needs your password to restore the Mac’s normal sleep.",
        adminPromptRecover: "Yaya's Space quit while the Mac’s sleep was disabled. Enter the password to restore normal sleep.",
        adminPromptUpdate: "Yaya's Space needs your password to install the update.",
        adminPromptSudoersInstall: "Yaya's Space will create a restricted rule (pmset disablesleep only) to toggle closed-lid mode without asking for a password. This is the only time the password is needed.",
        adminPromptSudoersRemove: "Yaya's Space will remove the password-free closed-lid rule.",

        settingsTitle: "Yaya's Space Settings",
        tabGeneral: "General",
        tabEnergy: "Energy",
        ...
        advancedResetDescription: "Removes every permission you granted Yaya's Space (Accessibility, Screen Recording, Full Disk Access and others), the login item and the closed-lid rule. Useful to start fresh or before uninstalling. The app stays installed.",
        ...
        advancedUninstallDescription: "Does all of the above, then removes the preferences and moves Yaya's Space to the Trash, leaving nothing behind. The app quits when done. You can reinstall anytime.",
        advancedUninstallButton: "Uninstall Yaya's Space completely",
        advancedUninstallConfirmTitle: "Uninstall Yaya's Space?",
        advancedUninstallConfirmBody: "Yaya's Space will clear its permissions, remove its preferences and move to the Trash, then quit. This can’t be undone from the app, but it stays in the Trash until you empty it.",
        advancedUninstallFailedTitle: "Uninstall stopped",
        advancedUninstallFailedBody: "Yaya's Space could not put back a system setting it changed: sleep, fan speed or mouse acceleration. Nothing was removed. Try again and allow the password request if it appears.",
        ...
        keepAwakeAutoStart: "Keep Awake when Yaya's Space opens",
        ...
        switcherEnable: "Use the Yaya's Space switcher",
        ...
        switcherTakeOverSystemShortcutsCaption: "Disables the matching macOS app and window shortcuts only while Yaya's Space’s switcher is active. All running apps stay reachable.",
        ...
        uninstallerFDAHint: "Turn Yaya's Space on in the list. If it isn’t there, click + and pick Yaya's Space from Applications. Access only applies after you reopen the app.",
        ...
        homebrewMissingBody: "Yaya's Space can open Terminal with the official Homebrew installer. Terminal shows the steps and asks for your password if needed.",
        ...
        homebrewShellSetupBody: "Homebrew is installed, but Terminal may not find the brew command yet. Yaya's Space can open Terminal with the setup command.",
        ...
        homebrewTerminalFallback: "This operation needs Terminal to ask for the administrator password. Yaya's Space does not capture passwords.",
        ...
        updateNotifyTitle: "Yaya's Space update",
        ...
        updateNeedsApplicationsTitle: "Move Yaya's Space to Applications",
        updateNeedsApplicationsBody: "The app is running from a place that cannot be updated, such as the disk image or a temporary system location. Drag Yaya's Space to the Applications folder, open it from there and try again.",
        ...
        obStart: "Open Yaya's Space",
        obStepWelcomeTitle: "Welcome to Yaya's Space",
        ...
        obStepDoneBody: "Yaya's Space is already looking after your Mac.",
        ...
        obLanguageUpdateBody: "Yaya's Space now speaks several languages. Choose the one you’d like to use; you can change it anytime in Settings.",
        ...
        cleaningNeedsAxBody: "To lock the keyboard safely, Yaya's Space needs Accessibility permission. Grant it in System Settings and try again.",
        ...
        donateHeading: "Help Yaya's Space keep growing",
        donateMessage: "Yaya's Space is free, independent and built in my spare time. If you would like to contribute financially, Buy Me a Coffee directly helps me keep development moving forward.",
        donateButton: "Support on Buy Me a Coffee",
        donateThanks: "Thank you for being here. 🖤",
        supportIntroTitle: "Help Yaya's Space keep growing",
        supportIntroMessage: "If you would like to support development financially, Buy Me a Coffee is the one place to do it.",
        supportIntroStarButton: "Star Yaya's Space on GitHub",
        supportIntroStarMessage: "Financial support is never expected. A star on GitHub helps more people discover Yaya's Space and makes a real difference to its development.",
        supportIntroCoffeeButton: "Support on Buy Me a Coffee",
        supportIntroLaterButton: "Not now",
        supportIntroDoneButton: "Done",
        discordIntroTitle: "The Yaya's Space Discord community is just getting started",
        discordIntroMessage: "The Yaya's Space community is new and still being built. Join early to meet other users and help build a welcoming space around the app.",
        ...
        communityIntroFollowButton: "Follow @YahyaElghobashy on X",
        homebrewOfficialIntroTitle: "Now in the official Homebrew catalog",
        homebrewOfficialIntroMessage: "Yaya's Space can now be installed directly from the official Homebrew catalog.",
        ...
        showMenuBarIconCaption: "If Yaya's Space’s icon disappears (macOS can hide menu bar icons when the bar runs out of room, common on Macs with a notch), reopen Yaya's Space from Applications or Spotlight: that rebuilds the icon and, if it’s still hidden, opens this window.",
        ...
        menuBarIconManagerHintFormat: "%@ is open and may be keeping the icon in its hidden section. Look for Yaya's Space there, or set %@ to always show Yaya's Space.",
        ...
        cleanerNotifDenied: "Yaya's Space notifications are turned off in the system.",
        cleanerNotifOpenSettings: "Open Notification Settings…",
        launchAtLoginNeedsApplications: "The app is running from a place that cannot open at login. Drag Yaya's Space to the Applications folder, open it from there and turn this on again.",
        launchAtLoginNeedsApproval: "The login item is registered but still switched off in System Settings. Open System Settings › General › Login Items & Extensions and turn Yaya's Space on under Open at Login.",
        ...
        mouseAccelerationCaption: "Removes pointer acceleration for connected mice. Your previous setting returns when this is turned off or Yaya's Space quits.",
