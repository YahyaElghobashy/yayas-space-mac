...
extension KillProcessFeatureStrings {
    static let enUS = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Yaya's Space needs administrator access to end “%@”."
    )
    ...
    static let ptBR = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "O Yaya's Space precisa de acesso de administrador para encerrar “%@”."
    )
    ...
    static let tr = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Yaya's Space’in “%@” işlemini sonlandırması için yönetici erişimi gerekiyor."
    )
    ...
    static let ru = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Yaya's Space нужны права администратора, чтобы завершить «%@»."
    )
    ...
    static let es = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Yaya's Space necesita acceso de administrador para finalizar “%@”."
    )
    ...
    static let de = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Yaya's Space benötigt Administratorrechte, um „%@“ zu beenden."
    )
    ...
    static let fr = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Yaya's Space a besoin d’un accès administrateur pour arrêter «\u{00A0}%@\u{00A0}»."
    )
    ...
    static let it = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Yaya's Space richiede l’accesso da amministratore per terminare “%@”."
    )
    ...
    static let zhHans = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Yaya's Space 需要您的管理员密码才能结束“%@”。"
    )
    ...
    static let zhTW = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "Yaya's Space 需要管理員權限才能結束「%@」。"
    )
