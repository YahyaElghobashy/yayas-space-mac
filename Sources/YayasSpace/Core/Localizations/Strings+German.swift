...
extension Strings {
    static let de = Strings(
        statusIdleTooltip: "Yaya's Space: normaler Ruhezustand",
        statusActiveUntil: "Yaya's Space: aktiv bis",
        statusActiveIndefinite: "Yaya's Space: dauerhaft aktiv",
        menuEnableAwake: "Wachhalten aktivieren",
        menuDisableAwake: "Wachhalten deaktivieren",
        menuActivateFor: "Aktivieren für…",
        menuSettings: "Einstellungen…",
        menuAbout: "Über Yaya's Space",
        menuQuit: "Yaya's Space beenden",
        menuHide: "Yaya's Space ausblenden",
        ...
        notifyBatteryTitle: "Yaya's Space deaktiviert",
        notifyBatteryBody: "Niedriger Batteriestand. Der normale Ruhezustand wurde wiederhergestellt, um die Ladung zu schonen.",
        adminPromptClamshellOn: "Yaya's Space benötigt dein Passwort, um bei zugeklapptem Mac weiterzulaufen.",
        adminPromptClamshellOff: "Yaya's Space benötigt dein Passwort, um den normalen Ruhezustand des Mac wiederherzustellen.",
        adminPromptRecover: "Yaya's Space wurde beendet, während der Ruhezustand des Mac deaktiviert war. Gib das Passwort ein, um den normalen Ruhezustand wiederherzustellen.",
        adminPromptUpdate: "Yaya's Space benötigt dein Passwort, um das Update zu installieren.",
        adminPromptSudoersInstall: "Yaya's Space legt eine eingeschränkte Regel an (nur pmset disablesleep), um den Modus bei geschlossenem Display ohne Passwortabfrage umzuschalten. Nur dieses eine Mal wird das Passwort benötigt.",
        adminPromptSudoersRemove: "Yaya's Space entfernt die passwortfreie Regel für das geschlossene Display.",

        settingsTitle: "Yaya's Space-Einstellungen",
        ...
        advancedResetDescription: "Entfernt alle Berechtigungen, die du Yaya's Space erteilt hast (Bedienungshilfen, Bildschirmaufnahme, Festplattenvollzugriff und weitere), das Anmeldeobjekt und die Regel für das geschlossene Display. Praktisch für einen Neustart oder vor dem Deinstallieren. Die App bleibt installiert.",
        ...
        advancedUninstallDescription: "Macht alles oben Genannte, entfernt dann die Einstellungen und bewegt Yaya's Space in den Papierkorb, ohne Rückstände zu hinterlassen. Die App beendet sich danach. Du kannst sie jederzeit neu installieren.",
        advancedUninstallButton: "Yaya's Space vollständig deinstallieren",
        advancedUninstallConfirmTitle: "Yaya's Space deinstallieren?",
        advancedUninstallConfirmBody: "Yaya's Space setzt seine Berechtigungen zurück, entfernt seine Einstellungen und wandert in den Papierkorb, dann beendet es sich. Das lässt sich aus der App nicht rückgängig machen, doch sie bleibt im Papierkorb, bis du ihn leerst.",
        advancedUninstallFailedTitle: "Deinstallation gestoppt",
        advancedUninstallFailedBody: "Yaya's Space konnte eine geänderte Systemeinstellung nicht wiederherstellen: Ruhezustand, Lüfterdrehzahl oder Mausbeschleunigung. Es wurde nichts entfernt. Versuche es erneut und erlaube die Kennwortabfrage, falls sie erscheint.",
        ...
        keepAwakeAutoStart: "Beim Öffnen von Yaya's Space wach halten",
        ...
        switcherEnable: "Yaya's Space-Umschalter verwenden",
        ...
        switcherTakeOverSystemShortcutsCaption: "Deaktiviert die passenden macOS-App- und Fensterkurzbefehle nur, solange YayasSpaces Umschalter aktiv ist. Alle laufenden Apps bleiben erreichbar.",
        ...
        uninstallerFDAHint: "Aktiviere Yaya's Space in der Liste. Fehlt es dort, klicke auf + und wähle Yaya's Space unter „Programme“. Der Zugriff gilt erst, nachdem du die App erneut öffnest.",
        ...
        homebrewMissingBody: "Yaya's Space kann Terminal mit dem offiziellen Homebrew-Installer öffnen. Terminal zeigt die Schritte und fragt bei Bedarf nach deinem Passwort.",
        ...
        homebrewShellSetupBody: "Homebrew ist installiert, aber Terminal findet den Befehl brew vielleicht noch nicht. Yaya's Space kann Terminal mit dem Konfigurationsbefehl öffnen.",
        ...
        homebrewTerminalFallback: "Diese Aktion benötigt Terminal, um nach dem Administratorpasswort zu fragen. Yaya's Space erfasst keine Passwörter.",
        ...
        updateNeedsApplicationsTitle: "Bewege Yaya's Space in den Ordner „Programme“",
        updateNeedsApplicationsBody: "Die App läuft an einem Ort, der nicht aktualisiert werden kann, etwa im Disk-Image oder an einem temporären Systemort. Ziehe Yaya's Space in den Ordner „Programme“, öffne es von dort und versuche es erneut.",
        ...
        obStart: "Yaya's Space öffnen",
        obStepWelcomeTitle: "Willkommen bei Yaya's Space",
        ...
        obStepDoneBody: "Yaya's Space kümmert sich bereits um deinen Mac.",
        ...
        obLanguageUpdateBody: "Yaya's Space spricht jetzt mehrere Sprachen. Wähle die, die du verwenden möchtest; du kannst sie jederzeit in den Einstellungen ändern.",
        ...
        cleaningNeedsAxBody: "Um die Tastatur sicher zu sperren, benötigt Yaya's Space die Berechtigung für Bedienungshilfen. Erteile sie in den Systemeinstellungen und versuche es erneut.",
        ...
        donateHeading: "Hilf Yaya's Space weiter zu wachsen",
        donateMessage: "Yaya's Space ist kostenlos, unabhängig und entsteht in meiner Freizeit. Wenn du die Entwicklung finanziell unterstützen möchtest, hilft Buy Me a Coffee direkt dabei, sie voranzubringen.",
        donateButton: "Über Buy Me a Coffee unterstützen",
        donateThanks: "Danke, dass du hier bist. 🖤",
        supportIntroTitle: "Hilf Yaya's Space weiter zu wachsen",
        supportIntroMessage: "Wenn du die Entwicklung finanziell unterstützen möchtest, ist Buy Me a Coffee der einzige Ort dafür.",
        supportIntroStarButton: "Yaya's Space auf GitHub einen Stern geben",
        supportIntroStarMessage: "Finanzielle Unterstützung wird nie erwartet. Ein Stern auf GitHub hilft mehr Menschen, Yaya's Space zu entdecken, und macht für die Entwicklung einen echten Unterschied.",
        ...
        discordIntroTitle: "Die Yaya's Space Community auf Discord steht noch am Anfang",
        discordIntroMessage: "Die Yaya's Space Community ist neu und wächst noch. Tritt früh bei, lerne andere Nutzer kennen und hilf, einen einladenden Ort rund um die App aufzubauen.",
        ...
        communityIntroFollowButton: "@YahyaElghobashy auf X folgen",
        homebrewOfficialIntroTitle: "Jetzt im offiziellen Katalog von Homebrew",
        homebrewOfficialIntroMessage: "Yaya's Space kann jetzt direkt aus dem offiziellen Katalog von Homebrew installiert werden.",
        ...
        showMenuBarIconCaption: "Falls das Symbol von Yaya's Space verschwindet (macOS kann Menüleistensymbole ausblenden, wenn der Platz in der Leiste knapp wird, häufig bei Macs mit Notch), öffne Yaya's Space erneut über „Programme“ oder Spotlight: Das stellt das Symbol wieder her und öffnet, falls es weiterhin ausgeblendet ist, dieses Fenster.",
        ...
        menuBarIconManagerHintFormat: "%@ läuft und hält das Symbol womöglich in seinem verborgenen Bereich. Suche Yaya's Space dort, oder stelle %@ so ein, dass Yaya's Space immer angezeigt wird.",
        ...
        cleanerNotifDenied: "Mitteilungen von Yaya's Space sind im System deaktiviert.",
        cleanerNotifOpenSettings: "Mitteilungseinstellungen öffnen…",
        launchAtLoginNeedsApplications: "Die App läuft von einem Ort, der das Öffnen bei der Anmeldung nicht erlaubt. Ziehe Yaya's Space in den Ordner Programme, öffne die App von dort und schalte die Option wieder ein.",
        launchAtLoginNeedsApproval: "Das Anmeldeobjekt ist registriert, in den Systemeinstellungen aber weiterhin aus. Öffne Systemeinstellungen › Allgemein › Anmeldeobjekte & Erweiterungen und schalte Yaya's Space unter „Bei der Anmeldung öffnen“ ein.",
        ...
        mouseAccelerationCaption: "Deaktiviert die Zeigerbeschleunigung für angeschlossene Mäuse. Die vorherige Einstellung wird beim Ausschalten oder Beenden von Yaya's Space wiederhergestellt.",
