...
extension Strings {
    static let es = Strings(
        statusIdleTooltip: "Yaya's Space: reposo normal",
        statusActiveUntil: "Yaya's Space: activo hasta",
        statusActiveIndefinite: "Yaya's Space: activo indefinidamente",
        menuEnableAwake: "Activar mantener activo",
        menuDisableAwake: "Desactivar mantener activo",
        menuActivateFor: "Activar durante…",
        menuSettings: "Ajustes…",
        menuAbout: "Acerca de Yaya's Space",
        menuQuit: "Salir de Yaya's Space",
        menuHide: "Ocultar Yaya's Space",
        ...
        notifyBatteryTitle: "Yaya's Space desactivado",
        notifyBatteryBody: "Batería baja. Se restauró el reposo normal para proteger la carga.",
        adminPromptClamshellOn: "Yaya's Space necesita tu contraseña para seguir con la tapa cerrada.",
        adminPromptClamshellOff: "Yaya's Space necesita tu contraseña para restaurar el reposo normal del Mac.",
        adminPromptRecover: "Yaya's Space se cerró mientras el reposo del Mac estaba desactivado. Introduce la contraseña para restaurar el reposo normal.",
        adminPromptUpdate: "Yaya's Space necesita tu contraseña para instalar la actualización.",
        adminPromptSudoersInstall: "Yaya's Space creará una regla restringida (solo pmset disablesleep) para alternar el modo de tapa cerrada sin pedir contraseña. Esta es la única vez que se necesita la contraseña.",
        adminPromptSudoersRemove: "Yaya's Space eliminará la regla de tapa cerrada sin contraseña.",

        settingsTitle: "Ajustes de Yaya's Space",
        tabGeneral: "General",
        tabEnergy: "Energía",
        ...
        advancedResetDescription: "Elimina todos los permisos que concediste a Yaya's Space (Accesibilidad, Grabación de pantalla, Acceso total al disco y otros), el ítem de inicio de sesión y la regla de tapa cerrada. Útil para empezar de cero o antes de desinstalar. La app sigue instalada.",
        ...
        advancedUninstallDescription: "Hace todo lo anterior y, además, elimina las preferencias y mueve Yaya's Space a la Papelera, sin dejar rastro. La app se cierra al terminar. Puedes reinstalarla cuando quieras.",
        advancedUninstallButton: "Desinstalar Yaya's Space por completo",
        advancedUninstallConfirmTitle: "¿Desinstalar Yaya's Space?",
        advancedUninstallConfirmBody: "Yaya's Space borrará sus permisos, eliminará sus preferencias y se moverá a la Papelera; después se cerrará. Esto no se puede deshacer desde la app, pero permanece en la Papelera hasta que la vacíes.",
        advancedUninstallFailedTitle: "La desinstalación se detuvo",
        advancedUninstallFailedBody: "Yaya's Space no pudo restaurar un ajuste del sistema que había cambiado: la suspensión, la velocidad de los ventiladores o la aceleración del ratón. No se eliminó nada. Inténtalo de nuevo y permite la solicitud de contraseña si aparece.",
        ...
        keepAwakeAutoStart: "Mantener activo al abrir Yaya's Space",
        ...
        switcherEnable: "Usar el selector de Yaya's Space",
        ...
        switcherTakeOverSystemShortcutsCaption: "Desactiva los atajos correspondientes de macOS solo mientras el selector de Yaya's Space está activo. Todas las apps abiertas siguen accesibles.",
        ...
        uninstallerFDAHint: "Activa Yaya's Space en la lista. Si no aparece, haz clic en + y elige Yaya's Space en Aplicaciones. El acceso solo se aplica después de volver a abrir la app.",
        ...
        homebrewMissingBody: "Yaya's Space puede abrir Terminal con el instalador oficial de Homebrew. Terminal muestra los pasos y pide tu contraseña si hace falta.",
        ...
        homebrewShellSetupBody: "Homebrew está instalado, pero Terminal quizá aún no encuentre el comando brew. Yaya's Space puede abrir Terminal con el comando de configuración.",
        ...
        homebrewTerminalFallback: "Esta operación necesita Terminal para pedir la contraseña de administrador. Yaya's Space no captura contraseñas.",
        ...
        updateNotifyTitle: "Actualización de Yaya's Space",
        ...
        updateNeedsApplicationsTitle: "Mueve Yaya's Space a Aplicaciones",
        updateNeedsApplicationsBody: "La app se está ejecutando desde un lugar que no se puede actualizar, como la imagen de disco o una ubicación temporal del sistema. Arrastra Yaya's Space a la carpeta Aplicaciones, ábrela desde ahí y vuelve a intentarlo.",
        ...
        obStart: "Abrir Yaya's Space",
        obStepWelcomeTitle: "Te damos la bienvenida a Yaya's Space",
        ...
        obStepDoneBody: "Yaya's Space ya está cuidando de tu Mac.",
        ...
        obLanguageUpdateBody: "Yaya's Space ahora habla varios idiomas. Elige el que quieras usar; puedes cambiarlo cuando quieras en Ajustes.",
        ...
        cleaningNeedsAxBody: "Para bloquear el teclado de forma segura, Yaya's Space necesita el permiso de Accesibilidad. Concédelo en Ajustes del Sistema e inténtalo de nuevo.",
        ...
        donateHeading: "Ayuda a que Yaya's Space siga creciendo",
        donateMessage: "Yaya's Space es gratis, independiente y lo desarrollo en mi tiempo libre. Si quieres contribuir económicamente, Buy Me a Coffee ayuda directamente a mantener el desarrollo en marcha.",
        donateButton: "Apoyar en Buy Me a Coffee",
        donateThanks: "Gracias por estar aquí. 🖤",
        supportIntroTitle: "Ayuda a que Yaya's Space siga creciendo",
        supportIntroMessage: "Si quieres apoyar económicamente el desarrollo, Buy Me a Coffee es el único lugar para hacerlo.",
        supportIntroStarButton: "Dar una estrella a Yaya's Space en GitHub",
        supportIntroStarMessage: "Nunca se espera apoyo económico. Una estrella en GitHub ayuda a que más personas descubran Yaya's Space y marca una diferencia real en su desarrollo.",
        supportIntroCoffeeButton: "Apoyar en Buy Me a Coffee",
        supportIntroLaterButton: "Ahora no",
        supportIntroDoneButton: "Listo",
        discordIntroTitle: "La comunidad de Yaya's Space en Discord acaba de empezar",
        discordIntroMessage: "La comunidad de Yaya's Space es nueva y todavía está tomando forma. Únete desde el principio para conocer a otros usuarios y ayudar a crear un espacio acogedor alrededor de la app.",
        ...
        communityIntroFollowButton: "Seguir a @YahyaElghobashy en X",
        homebrewOfficialIntroTitle: "Ahora en el catálogo oficial de Homebrew",
        homebrewOfficialIntroMessage: "Yaya's Space ya se puede instalar directamente desde el catálogo oficial de Homebrew.",
        ...
        showMenuBarIconCaption: "Si el icono de Yaya's Space desaparece (macOS puede ocultar iconos de la barra de menús cuando se queda sin espacio, algo habitual en Macs con notch), vuelve a abrir Yaya's Space desde Aplicaciones o Spotlight: eso recrea el icono y, si sigue oculto, abre esta ventana.",
        ...
        menuBarIconManagerHintFormat: "%@ está abierto y puede estar guardando el icono en su sección oculta. Busca Yaya's Space ahí, o configura %@ para mostrar siempre Yaya's Space.",
        ...
        cleanerNotifDenied: "Las notificaciones de Yaya's Space están desactivadas en el sistema.",
        cleanerNotifOpenSettings: "Abrir ajustes de notificaciones…",
        launchAtLoginNeedsApplications: "La app se está ejecutando desde un lugar que no permite abrirse al iniciar sesión. Arrastra Yaya's Space a la carpeta Aplicaciones, ábrelo desde ahí y actívalo de nuevo.",
        launchAtLoginNeedsApproval: "El ítem de inicio está registrado, pero sigue desactivado en Ajustes del Sistema. Abre Ajustes del Sistema › General › Ítems de inicio y extensiones y activa Yaya's Space en “Abrir al iniciar sesión”.",
        ...
        mouseAccelerationCaption: "Elimina la aceleración del puntero para los ratones conectados. El ajuste anterior vuelve al desactivarlo o salir de Yaya's Space.",
