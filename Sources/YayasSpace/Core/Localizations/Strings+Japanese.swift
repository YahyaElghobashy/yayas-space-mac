...
extension Strings {
    static let ja = Strings(
        statusIdleTooltip: "Yaya's Space：通常のスリープ",
        statusActiveUntil: "Yaya's Space：次の時刻までスリープしない",
        statusActiveIndefinite: "Yaya's Space：解除するまでスリープしない",
        menuEnableAwake: "スリープ防止をオン",
        menuDisableAwake: "スリープ防止をオフ",
        menuActivateFor: "時間を指定してオン…",
        menuSettings: "設定…",
        menuAbout: "Yaya's Space について",
        menuQuit: "Yaya's Space を終了",
        menuHide: "Yaya's Space を隠す",
        ...
        notifyBatteryTitle: "Yaya's Space をオフにしました",
        notifyBatteryBody: "バッテリー残量が少なくなりました。充電を保護するため通常のスリープに戻しました。",
        adminPromptClamshellOn: "ふたを閉じても続けるには、Yaya's Space にパスワードが必要です。",
        adminPromptClamshellOff: "Mac の通常のスリープを元に戻すにはパスワードが必要です。",
        adminPromptRecover: "Mac のスリープを無効化したまま Yaya's Space が終了しました。通常のスリープに戻すにはパスワードを入力してください。",
        adminPromptUpdate: "アップデートをインストールするには Yaya's Space にパスワードが必要です。",
        adminPromptSudoersInstall: "ふたを閉じたモードをパスワードなしで切り替えられるよう、Yaya's Space が制限付きルール（pmset disablesleep のみ）を作成します。パスワードが必要なのはこの一度きりです。",
        adminPromptSudoersRemove: "パスワード不要のふたを閉じたモードのルールを Yaya's Space が削除します。",

        settingsTitle: "Yaya's Space 設定",
        tabGeneral: "一般",
        tabEnergy: "省エネルギー",
        ...
        advancedResetDescription: "Yaya's Space に許可したすべてのアクセス権（アクセシビリティ、画面収録、フルディスクアクセスなど）、ログイン項目、ふたを閉じたモードのルールを削除します。最初からやり直すときや、アンインストールの前に便利です。アプリはインストールされたまま残ります。",
        ...
        advancedUninstallDescription: "上記をすべて実行したうえで、環境設定を削除し、Yaya's Space をゴミ箱に移動して、何も残しません。完了後にアプリは終了します。いつでも再インストールできます。",
        advancedUninstallButton: "Yaya's Space を完全にアンインストール",
        advancedUninstallConfirmTitle: "Yaya's Space をアンインストールしますか？",
        advancedUninstallConfirmBody: "Yaya's Space はアクセス権を消去し、環境設定を削除し、ゴミ箱に移動してから終了します。この操作はアプリからは取り消せませんが、ゴミ箱を空にするまではゴミ箱に残ります。",
        advancedUninstallFailedTitle: "アンインストールを中止しました",
        advancedUninstallFailedBody: "Yaya's Space が変更したシステム設定（スリープ、ファンの回転数、マウス加速）を元に戻せませんでした。何も削除していません。もう一度試して、パスワードの入力を求められたら許可してください。",
        ...
        keepAwakeAutoStart: "Yaya's Space起動時にスリープを防ぐ",
        ...
        switcherEnable: "Yaya's Space のスイッチャーを使う",
        ...
        switcherTakeOverSystemShortcutsCaption: "Yaya's Space のスイッチャーが動作中の間だけ、対応する macOS のアプリとウインドウのショートカットを無効にします。実行中のすべてのアプリに切り替えられます。",
        ...
        uninstallerFDAHint: "リストで Yaya's Space をオンにします。表示されない場合は + をクリックし、アプリケーションから Yaya's Space を選びます。アクセス権はアプリを再度開いた後に有効になります。",
        ...
        homebrewMissingBody: "Yaya's Space は公式 Homebrew インストーラを Terminal で開けます。Terminal に手順が表示され、必要ならパスワードを求められます。",
        ...
        homebrewShellSetupBody: "Homebrew はインストールされていますが、Terminal がまだ brew コマンドを見つけられない場合があります。Yaya's Space は設定コマンドを Terminal で開けます。",
        ...
        homebrewTerminalFallback: "この操作では管理者パスワードを求めるために Terminal が必要です。Yaya's Space はパスワードを取得しません。",
        ...
        updateNotifyTitle: "Yaya's Space のアップデート",
        updateInstallFailedBody: "アップデートはダウンロードされましたが、適用できませんでした。GitHub のリリースページから最新版をダウンロードし、現在のアプリの上にドラッグして置き換えてください。",
        updateNeedsApplicationsTitle: "Yaya's Space を「アプリケーション」に移動してください",
        updateNeedsApplicationsBody: "アプリが、ディスクイメージやシステムの一時的な場所など、アップデートできない場所から実行されています。Yaya's Space を「アプリケーション」フォルダにドラッグし、そこから開いてからもう一度お試しください。",
        ...
        obStart: "Yaya's Space を開く",
        obStepWelcomeTitle: "Yaya's Space へようこそ",
        ...
        obStepDoneBody: "Yaya's Space はすでにあなたの Mac を見守っています。",
        ...
        obLanguageUpdateBody: "Yaya's Space が複数の言語に対応しました。使いたい言語を選んでください。設定でいつでも変更できます。",
        ...
        cleaningNeedsAxBody: "キーボードを安全にロックするには、Yaya's Space にアクセシビリティのアクセス権が必要です。システム設定で許可して、もう一度お試しください。",
        ...
        donateHeading: "Yaya's Space の成長を支える",
        donateMessage: "Yaya's Space は無料で独立したアプリとして、わたしの空き時間に開発しています。金銭的に支援したい場合は、Buy Me a Coffee が開発の継続に直接役立ちます。",
        donateButton: "Buy Me a Coffee で支援する",
        donateThanks: "来てくれてありがとう。🖤",
        supportIntroTitle: "Yaya's Space の成長を支える",
        supportIntroMessage: "開発を金銭的に支援したい場合は、Buy Me a Coffee が唯一の窓口です。",
        supportIntroStarButton: "GitHub で Yaya's Space にスターを付ける",
        supportIntroStarMessage: "金銭的な支援は決して必要ではありません。GitHub のスターは、より多くの人が Yaya's Space を見つける助けになり、開発にも大きな力になります。",
        supportIntroCoffeeButton: "Buy Me a Coffee で支援する",
        supportIntroLaterButton: "今はしない",
        supportIntroDoneButton: "完了",
        discordIntroTitle: "Yaya's SpaceのDiscordコミュニティが始まります",
        discordIntroMessage: "Yaya's Space コミュニティは新しく、まだ成長の途中です。早い段階から参加して他のユーザーと出会い、アプリを囲む心地よい場所を一緒につくりましょう。",
        ...
        communityIntroFollowButton: "Xで@YahyaElghobashyをフォロー",
        homebrewOfficialIntroTitle: "Homebrew 公式カタログに登場",
        homebrewOfficialIntroMessage: "Yaya's Space を Homebrew 公式カタログから直接インストールできるようになりました。",
        ...
        showMenuBarIconCaption: "Yaya's Space のアイコンが消えた場合（メニューバーに空きがなくなると macOS がアイコンを隠すことがあり、ノッチのある Mac でよく起こります）、アプリケーションまたは Spotlight から Yaya's Space を開き直してください。アイコンが再作成され、それでも隠れている場合はこのウインドウが開きます。",
        ...
        menuBarIconManagerHintFormat: "%@ が起動中で、アイコンを隠しセクションにしまっている可能性があります。そこで Yaya's Space を探すか、%@ で Yaya's Space を常に表示する設定にしてください。",
        ...
        cleanerNotifDenied: "Yaya's Space の通知がシステムでオフになっています。",
        cleanerNotifOpenSettings: "通知設定を開く…",
        launchAtLoginNeedsApplications: "ログイン時に開けない場所からアプリが実行されています。Yaya's Spaceをアプリケーションフォルダにドラッグし、そこから開いてもう一度オンにしてください。",
        launchAtLoginNeedsApproval: "ログイン項目は登録されていますが、システム設定ではオフのままです。「システム設定 › 一般 › ログイン項目と機能拡張」を開き、「ログイン時に開く」でYaya's Spaceをオンにしてください。",
        ...
        mouseAccelerationCaption: "接続したマウスのポインタ加速を無効にします。オフにするか Yaya's Space を終了すると以前の設定に戻ります。",
