...
extension Strings {
    static let ru = Strings(
        statusIdleTooltip: "Yaya's Space: обычный сон",
        statusActiveUntil: "Yaya's Space: активно до",
        statusActiveIndefinite: "Yaya's Space: активно без срока",
        menuEnableAwake: "Включить режим без сна",
        menuDisableAwake: "Выключить режим без сна",
        menuActivateFor: "Включить на…",
        menuSettings: "Настройки…",
        menuAbout: "О Yaya's Space",
        menuQuit: "Выйти из Yaya's Space",
        menuHide: "Скрыть Yaya's Space",
        ...
        notifyBatteryTitle: "Yaya's Space отключён",
        notifyBatteryBody: "Низкий заряд. Обычный сон восстановлен, чтобы сохранить батарею.",
        adminPromptClamshellOn: "Yaya's Space нужен ваш пароль, чтобы Mac продолжал работать с закрытой крышкой.",
        adminPromptClamshellOff: "Yaya's Space нужен ваш пароль, чтобы вернуть обычный режим сна Mac.",
        adminPromptRecover: "Yaya's Space завершился, пока сон Mac был отключён. Введите пароль, чтобы вернуть обычный режим сна.",
        adminPromptUpdate: "Yaya's Space нужен ваш пароль, чтобы установить обновление.",
        adminPromptSudoersInstall: "Yaya's Space создаст ограниченное правило (только pmset disablesleep), чтобы переключать режим закрытой крышки без запроса пароля. Пароль понадобится только сейчас.",
        adminPromptSudoersRemove: "Yaya's Space удалит правило для режима закрытой крышки без пароля.",

        settingsTitle: "Настройки Yaya's Space",
        tabGeneral: "Основное",
        tabEnergy: "Питание",
        ...
        advancedResetDescription: "Удаляет все разрешения, которые вы дали Yaya's Space (Универсальный доступ, Запись экрана, Полный доступ к диску и другие), элемент входа и правило закрытой крышки. Полезно, если хотите начать с чистого листа или перед удалением. Приложение останется установленным.",
        ...
        advancedUninstallDescription: "Сделает всё вышеперечисленное, затем удалит настройки и переместит Yaya's Space в Корзину без остатка. После завершения приложение закроется. Установить его снова можно в любой момент.",
        advancedUninstallButton: "Удалить Yaya's Space полностью",
        advancedUninstallConfirmTitle: "Удалить Yaya's Space?",
        advancedUninstallConfirmBody: "Yaya's Space очистит разрешения, удалит настройки и переместится в Корзину, после чего закроется. Это нельзя отменить из приложения, но файл останется в Корзине, пока вы её не очистите.",
        advancedUninstallFailedTitle: "Удаление остановлено",
        advancedUninstallFailedBody: "Yaya's Space не смог вернуть изменённую системную настройку: режим сна, скорость вентиляторов или ускорение мыши. Ничего не удалено. Повторите попытку и разрешите запрос пароля, если он появится.",
        ...
        keepAwakeAutoStart: "Не давать уснуть при запуске Yaya's Space",
        ...
        switcherEnable: "Использовать переключатель Yaya's Space",
        ...
        switcherTakeOverSystemShortcutsCaption: "Отключает соответствующие сочетания macOS только на время работы переключателя Yaya's Space. Все запущенные приложения остаются доступны.",
        ...
        uninstallerFDAHint: "Включите Yaya's Space в списке. Если его там нет, нажмите + и выберите Yaya's Space из папки «Программы». Доступ начнёт действовать только после повторного запуска приложения.",
        ...
        homebrewMissingBody: "Yaya's Space может открыть Терминал с официальным установщиком Homebrew. Терминал покажет шаги и при необходимости запросит ваш пароль.",
        ...
        homebrewShellSetupBody: "Homebrew установлен, но Терминал может ещё не видеть команду brew. Yaya's Space может открыть Терминал с нужной командой настройки.",
        ...
        homebrewTerminalFallback: "Для этой операции нужен Терминал, чтобы запросить пароль администратора. Yaya's Space не перехватывает пароли.",
        ...
        updateNotifyTitle: "Обновление Yaya's Space",
        ...
        updateNeedsApplicationsTitle: "Переместите Yaya's Space в папку «Программы»",
        updateNeedsApplicationsBody: "Приложение запущено из места, которое нельзя обновить, например из образа диска или временного системного расположения. Перетащите Yaya's Space в папку «Программы», откройте его оттуда и попробуйте снова.",
        ...
        obStart: "Открыть Yaya's Space",
        obStepWelcomeTitle: "Добро пожаловать в Yaya's Space",
        ...
        obStepDoneBody: "Yaya's Space уже заботится о вашем Mac.",
        ...
        obLanguageUpdateBody: "Теперь Yaya's Space говорит на нескольких языках. Выберите тот, который хотите использовать; в любой момент его можно сменить в Настройках.",
        ...
        cleaningNeedsAxBody: "Чтобы безопасно блокировать клавиатуру, Yaya's Space нужен доступ к Универсальному доступу. Выдайте его в Системных настройках и попробуйте снова.",
        ...
        donateHeading: "Помогите Yaya's Space развиваться",
        donateMessage: "Yaya's Space бесплатен, независим и создаётся в моё свободное время. Если вы хотите помочь финансово, Buy Me a Coffee напрямую поддерживает дальнейшую разработку.",
        donateButton: "Поддержать через Buy Me a Coffee",
        donateThanks: "Спасибо, что вы здесь. 🖤",
        supportIntroTitle: "Помогите Yaya's Space развиваться",
        supportIntroMessage: "Если вы хотите финансово поддержать разработку, сделать это можно только через Buy Me a Coffee.",
        supportIntroStarButton: "Поставить Yaya's Space звезду на GitHub",
        supportIntroStarMessage: "Финансовая поддержка совсем не обязательна. Звезда на GitHub помогает большему числу людей найти Yaya's Space и действительно влияет на его развитие.",
        supportIntroCoffeeButton: "Поддержать через Buy Me a Coffee",
        supportIntroLaterButton: "Не сейчас",
        supportIntroDoneButton: "Готово",
        discordIntroTitle: "Сообщество Yaya's Space в Discord только начинает расти",
        discordIntroMessage: "Сообщество Yaya's Space новое и всё ещё формируется. Присоединяйтесь сейчас, знакомьтесь с другими пользователями и помогите создать дружелюбное пространство вокруг приложения.",
        ...
        communityIntroFollowButton: "Подписаться на @YahyaElghobashy в X",
        homebrewOfficialIntroTitle: "Теперь в официальном каталоге Homebrew",
        homebrewOfficialIntroMessage: "Теперь Yaya's Space можно установить прямо из официального каталога Homebrew.",
        ...
        showMenuBarIconCaption: "Если значок Yaya's Space исчезнет (macOS может скрывать значки строки меню, когда в ней не хватает места, что часто бывает на Mac с вырезом), откройте Yaya's Space снова из папки «Программы» или через Spotlight: это пересоздаст значок и, если он всё ещё скрыт, откроет это окно.",
        ...
        menuBarIconManagerHintFormat: "%@ запущен и, возможно, держит значок в своей скрытой секции. Поищите Yaya's Space там или настройте %@ всегда показывать Yaya's Space.",
        ...
        cleanerNotifDenied: "Уведомления Yaya's Space отключены в системе.",
        cleanerNotifOpenSettings: "Открыть настройки уведомлений…",
        launchAtLoginNeedsApplications: "Приложение запущено из места, из которого нельзя открываться при входе. Перетащите Yaya's Space в папку «Программы», откройте его оттуда и включите параметр снова.",
        launchAtLoginNeedsApproval: "Объект входа зарегистрирован, но в Системных настройках он выключен. Откройте «Системные настройки › Основные › Объекты входа и расширения» и включите Yaya's Space в разделе «Открывать при входе».",
        ...
        mouseAccelerationCaption: "Отключает ускорение указателя для подключённых мышей. Прежняя настройка вернётся после выключения функции или выхода из Yaya's Space.",
