...
extension Strings {
    static let ko = Strings(
        statusIdleTooltip: "Yaya's Space: 일반 절전",
        statusActiveUntil: "Yaya's Space: 다음 시간까지 절전 방지",
        statusActiveIndefinite: "Yaya's Space: 끌 때까지 절전 방지",
        menuEnableAwake: "절전 방지 켜기",
        menuDisableAwake: "절전 방지 끄기",
        menuActivateFor: "시간을 정해 켜기…",
        menuSettings: "설정…",
        menuAbout: "Yaya's Space 정보",
        menuQuit: "Yaya's Space 종료",
        menuHide: "Yaya's Space 가리기",
        ...
        notifyBatteryTitle: "Yaya's Space를 껐습니다",
        notifyBatteryBody: "배터리 잔량이 낮습니다. 충전을 보호하기 위해 일반 절전 모드로 되돌렸습니다.",
        adminPromptClamshellOn: "덮개를 닫아도 계속 사용하려면 Yaya's Space에 관리자 암호가 필요합니다.",
        adminPromptClamshellOff: "Mac의 일반 절전 모드를 복원하려면 관리자 암호가 필요합니다.",
        adminPromptRecover: "Mac의 절전이 비활성화된 상태에서 Yaya's Space가 종료되었습니다. 일반 절전 모드를 복원하려면 암호를 입력하세요.",
        adminPromptUpdate: "업데이트를 설치하려면 Yaya's Space에 관리자 암호가 필요합니다.",
        adminPromptSudoersInstall: "덮개 닫힘 모드를 암호 없이 전환할 수 있도록 Yaya's Space가 제한된 규칙(pmset disablesleep만)을 만듭니다. 암호는 이번 한 번만 필요합니다.",
        adminPromptSudoersRemove: "Yaya's Space가 암호 없이 사용하는 덮개 닫힘 모드 규칙을 제거합니다.",

        settingsTitle: "Yaya's Space 설정",
        tabGeneral: "일반",
        tabEnergy: "에너지",
        tabMouse: "마우스 및 트랙패드",
        tabSwitcher: "전환기",
        ...
        advancedResetDescription: "Yaya's Space에 허용한 모든 권한(손쉬운 사용, 화면 녹화, 전체 디스크 접근 등), 로그인 항목 및 덮개 닫힘 모드 규칙을 제거합니다. 처음부터 다시 시작하거나 앱을 삭제하기 전에 유용합니다. 앱은 설치된 상태로 유지됩니다.",
        ...
        advancedUninstallDescription: "위 작업을 모두 수행한 뒤 설정을 지우고 Yaya's Space를 휴지통으로 옮겨 아무것도 남기지 않습니다. 완료되면 앱이 종료됩니다. 언제든 다시 설치할 수 있습니다.",
        advancedUninstallButton: "Yaya's Space 완전히 제거",
        advancedUninstallConfirmTitle: "Yaya's Space를 제거할까요?",
        advancedUninstallConfirmBody: "Yaya's Space가 권한과 설정을 지우고 휴지통으로 이동한 뒤 종료됩니다. 이 작업은 앱에서 되돌릴 수 없지만 휴지통을 비우기 전까지는 복원할 수 있습니다.",
        advancedUninstallFailedTitle: "제거를 중단했습니다",
        advancedUninstallFailedBody: "Yaya's Space가 변경한 시스템 설정을 되돌리지 못했습니다. 잠자기, 팬 속도 또는 마우스 가속입니다. 아무것도 삭제되지 않았습니다. 다시 시도하고 암호를 요청하면 허용하세요.",
        ...
        keepAwakeAutoStart: "Yaya's Space 실행 시 잠자기 방지",
        ...
        switcherEnable: "Yaya's Space 전환기 사용",
        ...
        switcherTakeOverSystemShortcutsCaption: "Yaya's Space 전환기가 활성화된 동안에만 해당 macOS 앱 및 윈도우 단축키를 끕니다. 실행 중인 모든 앱에 계속 접근할 수 있습니다.",
        ...
        uninstallerFDAHint: "목록에서 Yaya's Space를 켜세요. 표시되지 않으면 +를 클릭하고 응용 프로그램에서 Yaya's Space를 선택하세요. 앱을 다시 열면 권한이 적용됩니다.",
        ...
        homebrewMissingBody: "Yaya's Space에서 공식 Homebrew 설치 관리자를 Terminal로 열 수 있습니다. Terminal에 단계가 표시되며 필요하면 암호를 요청합니다.",
        ...
        homebrewShellSetupBody: "Homebrew는 설치되었지만 Terminal에서 아직 brew 명령을 찾지 못할 수 있습니다. Yaya's Space에서 설정 명령을 Terminal로 열 수 있습니다.",
        ...
        homebrewTerminalFallback: "이 작업은 관리자 암호를 요청하기 위해 Terminal이 필요합니다. Yaya's Space는 암호를 수집하지 않습니다.",
        ...
        updateNotifyTitle: "Yaya's Space 업데이트",
        updateInstallFailedBody: "업데이트를 다운로드했지만 적용하지 못했습니다. GitHub 릴리스 페이지에서 최신 버전을 다운로드하고 현재 앱 위로 드래그해 교체하세요.",
        updateNeedsApplicationsTitle: "Yaya's Space를 ‘응용 프로그램’으로 이동하세요",
        updateNeedsApplicationsBody: "앱이 디스크 이미지나 시스템 임시 위치처럼 업데이트할 수 없는 위치에서 실행 중입니다. Yaya's Space를 ‘응용 프로그램’ 폴더로 드래그하고 그곳에서 연 뒤 다시 시도하세요.",
        ...
        obStart: "Yaya's Space 열기",
        obStepWelcomeTitle: "Yaya's Space에 오신 것을 환영합니다",
        ...
        obStepDoneBody: "Yaya's Space가 이미 Mac을 살피고 있습니다.",
        ...
        obLanguageUpdateBody: "Yaya's Space가 여러 언어를 지원합니다. 사용할 언어를 선택하세요. 설정에서 언제든 변경할 수 있습니다.",
        ...
        cleaningNeedsAxBody: "키보드를 안전하게 잠그려면 Yaya's Space에 손쉬운 사용 권한이 필요합니다. 시스템 설정에서 허용한 뒤 다시 시도하세요.",
        ...
        donateHeading: "Yaya's Space의 성장을 도와주세요",
        donateMessage: "Yaya's Space는 무료로 독립적으로 운영되며 여유 시간에 개발하고 있습니다. 금전적으로 돕고 싶다면 Buy Me a Coffee를 통한 지원이 개발을 이어 가는 데 직접 도움이 됩니다.",
        donateButton: "Buy Me a Coffee에서 후원하기",
        donateThanks: "들러 주셔서 감사합니다. 🖤",
        supportIntroTitle: "Yaya's Space의 성장을 도와주세요",
        supportIntroMessage: "개발을 금전적으로 돕고 싶다면 Buy Me a Coffee가 유일한 후원 창구입니다.",
        supportIntroStarButton: "GitHub에서 Yaya's Space에 별표 남기기",
        supportIntroStarMessage: "금전적인 후원은 전혀 기대하지 않습니다. GitHub의 별표 하나가 더 많은 사람이 Yaya's Space를 발견하게 하고 개발에도 큰 힘이 됩니다.",
        supportIntroCoffeeButton: "Buy Me a Coffee에서 후원하기",
        supportIntroLaterButton: "나중에",
        supportIntroDoneButton: "완료",
        discordIntroTitle: "Yaya's Space Discord 커뮤니티가 이제 시작됩니다",
        discordIntroMessage: "Yaya's Space 커뮤니티는 새롭게 만들어지는 중입니다. 일찍 참여해 다른 사용자와 만나고 앱을 중심으로 따뜻한 공간을 함께 만들어 주세요.",
        ...
        communityIntroFollowButton: "X에서 @YahyaElghobashy 팔로우",
        homebrewOfficialIntroTitle: "이제 Homebrew 공식 카탈로그에서 제공",
        homebrewOfficialIntroMessage: "이제 Homebrew 공식 카탈로그에서 Yaya's Space를 바로 설치할 수 있습니다.",
        ...
        showMenuBarIconCaption: "Yaya's Space 아이콘이 사라진 경우(메뉴 막대 공간이 부족하면 macOS가 아이콘을 숨길 수 있으며 노치가 있는 Mac에서 특히 흔합니다) 응용 프로그램 또는 Spotlight에서 Yaya's Space를 다시 여세요. 아이콘을 다시 만들고, 그래도 숨겨져 있으면 이 윈도우가 열립니다.",
        ...
        menuBarIconManagerHintFormat: "%@이(가) 실행 중이며 아이콘을 숨김 섹션에 넣었을 수 있습니다. 그곳에서 Yaya's Space를 찾거나 %@에서 Yaya's Space가 항상 표시되도록 설정하세요.",
        ...
        cleanerNotifDenied: "시스템에서 Yaya's Space 알림이 꺼져 있습니다.",
        cleanerNotifOpenSettings: "알림 설정 열기…",
        launchAtLoginNeedsApplications: "로그인 시 열 수 없는 위치에서 앱이 실행되고 있습니다. Yaya's Space를 응용 프로그램 폴더로 드래그한 다음 거기에서 열고 이 옵션을 다시 켜 주세요.",
        launchAtLoginNeedsApproval: "로그인 항목은 등록되었지만 시스템 설정에서는 여전히 꺼져 있습니다. 시스템 설정 › 일반 › 로그인 항목 및 확장 프로그램을 열고 ‘로그인 시 열기’에서 Yaya's Space를 켜 주세요.",
        ...
        mouseAccelerationCaption: "연결된 마우스의 포인터 가속을 끕니다. 옵션을 끄거나 Yaya's Space를 종료하면 이전 설정으로 복원됩니다.",
