...
struct ReleaseNotes {
    ...
    private static func isDistributionFooter(_ line: String) -> Bool {
        ...
        return normalized == "Signed with an Apple Developer ID and notarized by Apple, so it downloads and opens normally. Requires macOS 14 or later. Open the .dmg below and drag Yaya's Space to Applications."
    }
}
