...
extension PermissionGuideStrings {
    static let ko = PermissionGuideStrings(
        ...
        stepToggle: "그 목록에서 Yaya's Space를 켜세요.",
...
extension PermissionGuideStrings {
    static let enUS = PermissionGuideStrings(
        ...
        stepToggle: "Turn Yaya's Space on in that list.",
    ...
    static let ptBR = PermissionGuideStrings(
        ...
        stepToggle: "Ligue o Yaya's Space nessa lista.",
    ...
    static let tr = PermissionGuideStrings(
        ...
        stepToggle: "O listede Yaya's Space’i açın.",
    ...
    static let ru = PermissionGuideStrings(
        ...
        stepToggle: "Включите Yaya's Space в этом списке.",
    ...
    static let es = PermissionGuideStrings(
        ...
        stepToggle: "Activa Yaya's Space en esa lista.",
    ...
    static let de = PermissionGuideStrings(
        ...
        stepToggle: "Schalte Yaya's Space in dieser Liste ein.",
    ...
    static let fr = PermissionGuideStrings(
        ...
        stepToggle: "Activez Yaya's Space dans cette liste.",
    ...
    static let it = PermissionGuideStrings(
        ...
        stepToggle: "Attiva Yaya's Space in quell’elenco.",
    ...
    static let ja = PermissionGuideStrings(
        ...
        stepToggle: "そのリストでYaya's Spaceをオンにしてください。",
    ...
    static let zhHans = PermissionGuideStrings(
        ...
        stepToggle: "在列表中开启 Yaya's Space。",
    ...
    static let zhTW = PermissionGuideStrings(
        ...
        stepToggle: "在清單中開啟 Yaya's Space。",
