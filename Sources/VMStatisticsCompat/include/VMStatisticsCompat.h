...
#ifndef YAYASSPACE_VM_STATISTICS_COMPAT_H
#define YAYASSPACE_VM_STATISTICS_COMPAT_H
...
} __attribute__((aligned(8))) yayasspace_vm_statistics64_rev3_t;

enum {
    YAYASSPACE_HOST_VM_INFO64_REV1_COUNT =
        offsetof(yayasspace_vm_statistics64_rev3_t, swapped_count) / sizeof(integer_t),
    YAYASSPACE_HOST_VM_INFO64_REV2_COUNT =
        offsetof(yayasspace_vm_statistics64_rev3_t, total_tag_storage_pages) / sizeof(integer_t),
    YAYASSPACE_HOST_VM_INFO64_REV3_COUNT =
        sizeof(yayasspace_vm_statistics64_rev3_t) / sizeof(integer_t),
};

_Static_assert(sizeof(integer_t) == 4, "HOST_VM_INFO64 counts must use 32-bit integer_t words");
_Static_assert(_Alignof(yayasspace_vm_statistics64_rev3_t) == 8,
               "vm_statistics64 rev3 must remain 64-bit aligned");
_Static_assert(sizeof(yayasspace_vm_statistics64_rev3_t) == 248,
               "unexpected HOST_VM_INFO64 rev3 size");
_Static_assert(offsetof(yayasspace_vm_statistics64_rev3_t, total_tag_storage_pages) == 160,
...
_Static_assert(offsetof(yayasspace_vm_statistics64_rev3_t, wire_count) ==
                   offsetof(vm_statistics64_data_t, wire_count),
               "wire_count layout mismatch");
_Static_assert(offsetof(yayasspace_vm_statistics64_rev3_t, purgeable_count) ==
                   offsetof(vm_statistics64_data_t, purgeable_count),
               "purgeable_count layout mismatch");
_Static_assert(offsetof(yayasspace_vm_statistics64_rev3_t, compressor_page_count) ==
                   offsetof(vm_statistics64_data_t, compressor_page_count),
               "compressor_page_count layout mismatch");
_Static_assert(offsetof(yayasspace_vm_statistics64_rev3_t, external_page_count) ==
                   offsetof(vm_statistics64_data_t, external_page_count),
               "external_page_count layout mismatch");
_Static_assert(offsetof(yayasspace_vm_statistics64_rev3_t, internal_page_count) ==
                   offsetof(vm_statistics64_data_t, internal_page_count),
               "internal_page_count layout mismatch");
_Static_assert(offsetof(yayasspace_vm_statistics64_rev3_t,
                        total_uncompressed_pages_in_compressor) ==
                   offsetof(vm_statistics64_data_t,
                            total_uncompressed_pages_in_compressor),
               "total_uncompressed_pages_in_compressor layout mismatch");
_Static_assert(YAYASSPACE_HOST_VM_INFO64_REV1_COUNT == HOST_VM_INFO64_REV1_COUNT,
...
_Static_assert(offsetof(yayasspace_vm_statistics64_rev3_t, swapped_count) ==
                   offsetof(vm_statistics64_data_t, swapped_count),
               "swapped_count layout mismatch with the active SDK");
_Static_assert(YAYASSPACE_HOST_VM_INFO64_REV2_COUNT == HOST_VM_INFO64_REV2_COUNT,
               "HOST_VM_INFO64 rev2 count mismatch with the active SDK");
#endif

#ifdef HOST_VM_INFO64_REV3_COUNT
_Static_assert(YAYASSPACE_HOST_VM_INFO64_REV3_COUNT == HOST_VM_INFO64_REV3_COUNT,
               "HOST_VM_INFO64 rev3 count mismatch with the active SDK");
_Static_assert(offsetof(yayasspace_vm_statistics64_rev3_t, total_tag_storage_pages) ==
...
yayasspace_read_vm_statistics64(yayasspace_vm_statistics64_rev3_t *statistics,
    ...
    *returned_count = YAYASSPACE_HOST_VM_INFO64_REV3_COUNT;
